...
var Gitpod = /** @class */ (function () {
    function Gitpod(context, config, stat) {
        ...
        this.config = config;
        this.stat = stat;
        context.log.debug('config: ' + JSON.stringify(config, function (_, value) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        key = owner + '/' + repo;
                        stat = stats.get(key) || { owner: owner, repo: repo, issues: 0, pulls: 0 };
                        stats.set(key, stat);
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, new Gitpod(context, {
                                pulls: {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        body = "[Open in Gitpod](https://gitpod.io#" + html_url + ")" + this.config[kind].comment;
    ...
    Gitpod.prototype.match = function (kind, issue) {
        ...
        return issue.labels.some(function (label) { return labels.has(label.name); });
    };
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 3:
                        ...
                        label = _c.value;
                        return [4 /*yield*/, this.doMarkAll(kind, query + " label:\"" + label + "\"")];
                    case 4:
                        _d.sent();
                        _d.label = 5;
                    case 5:
    ...
    Gitpod.prototype.doMarkAll = function (kind, query) {
        return __awaiter(this, void 0, void 0, function () {
            var e_2, _a, e_3, _b, pages, pages_1, pages_1_1, issues, issues_1, issues_1_1, issue, e_3_1, e_2_1;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, this.findIssues(query)];
                    case 1:
                        pages = _c.sent();
                        _c.label = 2;
                    case 2:
                    ...
                    case 10:
                        try {
                            if (issues_1_1 && !issues_1_1.done && (_b = issues_1.return)) _b.call(issues_1);
                        }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        github = this.context.github;
                        pages = [];
                        return [4 /*yield*/, github.search.issues({ q: q, sort: 'updated', per_page: 100 })];
                    case 1:
                        response = _a.sent();
    ...
    Gitpod.prototype.createQuery = function (kind) {
        var _a = this.context.repo(), owner = _a.owner, repo = _a.repo;
...
module.exports = function (app) {
    ...
    app.on('pull_request.opened', function (context) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, Gitpod.create(context, scheduler, stats)];
                case 1:
                    gitpod = _a.sent();
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    number = issue.number;
                    _a = issue;
                    return [4 /*yield*/, context.github.issues.getIssueLabels(context.repo({ number: number }))];
                case 2:
