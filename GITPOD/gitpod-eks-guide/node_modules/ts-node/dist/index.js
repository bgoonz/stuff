...
function versionGte(version, requirement) {
...
exports.DEFAULTS = {
    ...
    experimentalReplAwait: (_b = util_1.yn(exports.env.TS_NODE_EXPERIMENTAL_REPL_AWAIT)) !== null && _b !== void 0 ? _b : undefined,
};
/**
...
function create(rawOptions = {}) {
    ...
    function addDiagnosticFilter(filter) {
        diagnosticFilters.push(Object.assign(Object.assign({}, filter), { filenamesAbsolute: filter.filenamesAbsolute.map((f) => util_1.normalizeSlashes(f)) }));
    }
    return {
        ts,
        config,
