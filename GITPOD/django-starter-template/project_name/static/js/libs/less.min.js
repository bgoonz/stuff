      ...
      7: [
        function (a, b) {
          ...
          b.exports = function (b, e) {
            ...
            function i(a) {
              for (
                var b, c = m.getElementsByTagName("style"), d = 0;
                c.length > d;
                d++
              )
            ...
            e.functions &&
              n.functions.functionRegistry.addMultiple(e.functions);
            var t = /^text\/(x-)?less$/;
            return (
              (n.watch = function () {
                return (
                ...
                return new Promise(function (a) {
                  ...
                  for (var c = 0; b.length > c; c++)
                    ("stylesheet/less" === b[c].rel ||
                      (b[c].rel.match(/stylesheet/) && b[c].type.match(t))) &&
                      n.sheets.push(b[c]);
                  a();
                });
              }),
      ...
      15: [
        function (a, b) {
          ...
          (d.prototype.getFileManager = function (a, b, d, e, f) {
            ...
            d.pluginManager &&
              (g = [].concat(g).concat(d.pluginManager.getFileManagers()));
        ...
        function (a) {
          ...
          (f = {
            ...
            saturate: function (a, d, e) {
              ...
              return (
                (f.s +=
                  "undefined" != typeof e && "relative" === e.value
                    ? (f.s * d.value) / 100
                    : d.value / 100),
                (f.s = b(f.s)),
                c(f)
          ...
          b.exports = function () {
            ...
            g.add("svg-gradient", function (a) {
              ...
              return (
                ...
                new f(
                  new e("'" + j + "'", j, !1, this.index, this.currentFileInfo),
                  this.index,
                  this.currentFileInfo
                )
              );
              ...
              if (!(a instanceof d))
                throw {
                  ...
                  message:
                    ...
                    (a instanceof i ? ". Have you forgotten parenthesis?" : ""),
                };
              return (
                (c = c ? (c instanceof b ? c.value : c.toCSS()) : ""),
                new d(a.value, c)
              );
            },
            "get-unit": function (a) {
                ...
                var n = function (a) {
                    ...
                    (i.processImports = !1),
                      ...
                      h.plugin
                        ...
                        : h.inline
                        ? k(null, f, b)
                        : new d(i, j, l).parse(f, function (a, c) {
                            k(a, c, b);
                          });
                  },
                  o = m.loadFile(
          ...
          b.exports = function (b, g, h) {
            var i = function (b, g, j) {
              if (
                ...
                c ||
                  (c = "undefined" == typeof Promise ? a("promise") : Promise);
                var k = this;
                  ...
                  plugin: function () {
                    ...
                    if (c) {
                      ...
                      if ((a = this.entities.quoted() || this.entities.url()))
                        return (
                          o.$char(";") ||
                            ((o.i = b), l("missing semi-colon on plugin")),
        ...
        function (a, b) {
          ...
          (f.prototype = new c()),
            ...
            (f.prototype.find = function () {
              return this.rules
                ? e.prototype.find.apply(this.rules[0], arguments)
                : void 0;
            }),
          ...
          (g.prototype = new c()),
            ...
            (g.prototype.eval = function (a) {
              function b(b, c) {
                var d, e;
                for (k = 0; 2 > k; k++) {
                  for (w[k] = !0, f.value(k), d = 0; c.length > d && w[k]; d++)
                    (e = c[d]),
                      e.matchCondition &&
              ...
              for (
                ...
                if ((c = a.frames[i].find(this.selector, null, s)).length > 0) {
                  ...
                  for (f.reset(), q = [0, 0, 0], j = 0; v.length > j; j++)
                    q[v[j].group]++;
                  if (q[y] > 0) p = A;
          ...
          (l.prototype = new c()),
            ...
            (l.prototype.matchCondition = function (a, b) {
              ...
              return c.evaldCondition
                ? c.condition && !c.condition.eval(new h.Eval(b, b.frames))
                  ? !1
                  : !0
                : !1;
            }),
            ...
            (l.prototype.joinSelector = function (a, b, c) {
              ...
              function h(a, b) {
                var c, d;
                return (
                  (c = new f(null, a, b.index, b.currentFileInfo)),
                  (d = new e([c]))
                );
              }
              function i(a, b, c) {
                  ...
                  if (((s = c.elements[g]), "&" !== s.value)) {
                    ...
                    for (v = !0, q = [], l(o, p), m = 0; p.length > m; m++)
                      if (((r = p[m]), 0 === b.length))
                        r.length > 0 &&
                          r[0].elements.push(
                            new f(s.combinator, "", s.index, s.currentFileInfo)
                          ),
                          q.push(r);
                      else
              ...
              function j(a, b, c, d) {
                ...
                if (
                  ...
                  a.length > 0
                    ? ((e = a.slice(0)),
                      (g = e.pop()),
                      (h = d.createDerived(g.elements.slice(0))))
                    : (h = d.createDerived([])),
                  b.length > 0)
                ) {
                  var i = c.combinator,
                  ...
                  i.emptyOrWhitespace &&
                    ...
                    (i = j.combinator),
                    h.elements.push(
                      new f(i, j.value, c.index, c.currentFileInfo)
                    ),
        ...
        function (a, b) {
          ...
          (e.prototype = new c()),
            ...
            (e.prototype.createDerived = function (a, b, c) {
              ...
              return (
                (d.evaldCondition = c), (d.mediaEmpty = this.mediaEmpty), d
              );
            }),
        ...
        function (a, b) {
          ...
          (d.prototype = {
            ...
            visitDirective: function (a) {
              ...
              a.rules &&
                a.rules.length &&
                (a.rules[0].root = a.isRooted || 0 === b.length || null);
            },
          }),
            (b.exports = d);
        },
        ...
        function (a, b) {
          ...
          (e.prototype = {
            ...
            visitImport: function (a) {
              return void 0 !== a.path.currentFileInfo.reference && a.css
                ? void 0
                : a;
            },
