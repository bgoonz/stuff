...
const FileIssue = () => (
  <Styled id="add-my-project">
    <div className="card">
      ...
      <p>
        <strong>
          Do you want to streamline the experience for your contributors?{" "}
        </strong>
      </p>
      <p>
        We’re happy to help automate your project’s dev environment. Please file
        an issue with a link to your repository and we’ll help you set it up.
        Once the experience is great we’re happy to add your project to the
        list.
      </p>
