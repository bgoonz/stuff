          ...
          <div>
            {(this.state.filteredProjects.length &&
              this.state.filteredProjects.map((project) => (
                <Project key={project.repoName} {...project} />
              ))) ||
              (this.state.toggle && (
                <div className="nothing-found">
                  <img src={IconSmiley} alt="" aria-hidden={true} />
                  <h4>
                    Sorry, we can't find any projects matching your search
                  </h4>
                  <p>
                    Try&nbsp;
                    <button onClick={() => this.handleSearch("help wanted")}>
                      help wanted
                    </button>
                    ,&nbsp;
                    <button onClick={() => this.handleSearch("Prs welcome")}>
                      PRs welcome
                    </button>
                    , &nbsp;
                    <button
