  ...
  <SectionAboutGitpod>
    <div className="row">
      ...
      <div className="contents">
        ...
        <div className="text">
          <h3>
            Introducing Gitpod — Frictionless Coding on GitLab, GitHub &
            Bitbucket
          </h3>
          <p>
            Every day developers waste millions of hours switching contexts
            between projects and branches, setting up development environments,
            or simply waiting for builds to complete.
          </p>
          <a
