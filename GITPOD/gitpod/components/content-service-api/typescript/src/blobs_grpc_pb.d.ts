...
interface IBlobServiceService_IUploadUrl
  extends grpc.MethodDefinition<
    blobs_pb.UploadUrlRequest,
    blobs_pb.UploadUrlResponse
  > {
...
interface IBlobServiceService_IDownloadUrl
  extends grpc.MethodDefinition<
    blobs_pb.DownloadUrlRequest,
    blobs_pb.DownloadUrlResponse
  > {
...
interface IBlobServiceService_IDelete
  extends grpc.MethodDefinition<
    blobs_pb.DeleteRequest,
    blobs_pb.DeleteResponse
  > {
...
export interface IBlobServiceClient {
  uploadUrl(
    ...
    callback: (
      ...
      response: blobs_pb.UploadUrlResponse
    ) => void
  ...
  downloadUrl(
    ...
    callback: (
      error: grpc.ServiceError | null,
      response: blobs_pb.DownloadUrlResponse
    ) => void
  ): grpc.ClientUnaryCall;
  downloadUrl(
    request: blobs_pb.DownloadUrlRequest,
  ...
  delete(
    ...
    callback: (
      error: grpc.ServiceError | null,
      response: blobs_pb.DeleteResponse
    ) => void
  ): grpc.ClientUnaryCall;
  delete(
    request: blobs_pb.DeleteRequest,
