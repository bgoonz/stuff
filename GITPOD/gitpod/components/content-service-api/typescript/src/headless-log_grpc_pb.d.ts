...
interface IHeadlessLogServiceService
...
interface IHeadlessLogServiceService_ILogDownloadURL
  extends grpc.MethodDefinition<
    headless_log_pb.LogDownloadURLRequest,
    headless_log_pb.LogDownloadURLResponse
  > {
...
interface IHeadlessLogServiceService_IListLogs
  extends grpc.MethodDefinition<
    headless_log_pb.ListLogsRequest,
    headless_log_pb.ListLogsResponse
  > {
...
export interface IHeadlessLogServiceServer
  extends grpc.UntypedServiceImplementation {
  logDownloadURL: grpc.handleUnaryCall<
    headless_log_pb.LogDownloadURLRequest,
    headless_log_pb.LogDownloadURLResponse
  >;
  listLogs: grpc.handleUnaryCall<
    headless_log_pb.ListLogsRequest,
    headless_log_pb.ListLogsResponse
  >;
}
...
export interface IHeadlessLogServiceClient {
  logDownloadURL(
    ...
    callback: (
      ...
      response: headless_log_pb.LogDownloadURLResponse
    ) => void
  ...
  listLogs(
    ...
    callback: (
      error: grpc.ServiceError | null,
      response: headless_log_pb.ListLogsResponse
    ) => void
  ): grpc.ClientUnaryCall;
  listLogs(
    request: headless_log_pb.ListLogsRequest,
...
export class HeadlessLogServiceClient
  extends grpc.Client
  implements IHeadlessLogServiceClient
{
  constructor(
    address: string,
