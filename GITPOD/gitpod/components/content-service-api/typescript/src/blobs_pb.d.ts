...
export class UploadUrlRequest extends jspb.Message {
  ...
  static toObject(
    ...
    msg: UploadUrlRequest
  ): UploadUrlRequest.AsObject;
...
export class UploadUrlResponse extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: UploadUrlResponse
  ): UploadUrlResponse.AsObject;
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
  static extensionsBinary: {
    [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>;
  };
...
export class DownloadUrlRequest extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: DownloadUrlRequest
  ): DownloadUrlRequest.AsObject;
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
  static extensionsBinary: {
    [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>;
  };
...
export class DownloadUrlResponse extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: DownloadUrlResponse
  ): DownloadUrlResponse.AsObject;
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
  static extensionsBinary: {
    [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>;
  };
