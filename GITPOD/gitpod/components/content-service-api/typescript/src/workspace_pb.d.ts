...
export class WorkspaceDownloadURLRequest extends jspb.Message {
  ...
  static toObject(
    ...
    msg: WorkspaceDownloadURLRequest
  ): WorkspaceDownloadURLRequest.AsObject;
...
export class WorkspaceDownloadURLResponse extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: WorkspaceDownloadURLResponse
  ): WorkspaceDownloadURLResponse.AsObject;
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
  static extensionsBinary: {
    [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>;
  };
...
export class DeleteWorkspaceRequest extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: DeleteWorkspaceRequest
  ): DeleteWorkspaceRequest.AsObject;
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
  static extensionsBinary: {
    [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>;
  };
...
export class DeleteWorkspaceResponse extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: DeleteWorkspaceResponse
  ): DeleteWorkspaceResponse.AsObject;
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
  static extensionsBinary: {
    [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>;
  };
