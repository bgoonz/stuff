...
interface IIDEPluginServiceService
...
interface IIDEPluginServiceService_IUploadURL
  extends grpc.MethodDefinition<
    ideplugin_pb.PluginUploadURLRequest,
...
interface IIDEPluginServiceService_IDownloadURL
  extends grpc.MethodDefinition<
    ideplugin_pb.PluginDownloadURLRequest,
    ideplugin_pb.PluginDownloadURLResponse
  > {
...
interface IIDEPluginServiceService_IPluginHash
  extends grpc.MethodDefinition<
    ideplugin_pb.PluginHashRequest,
    ideplugin_pb.PluginHashResponse
  > {
...
export interface IIDEPluginServiceServer
  ...
  uploadURL: grpc.handleUnaryCall<
    ...
    ideplugin_pb.PluginUploadURLResponse
  >;
  downloadURL: grpc.handleUnaryCall<
    ideplugin_pb.PluginDownloadURLRequest,
    ideplugin_pb.PluginDownloadURLResponse
  >;
  pluginHash: grpc.handleUnaryCall<
    ideplugin_pb.PluginHashRequest,
    ideplugin_pb.PluginHashResponse
  >;
}
...
export interface IIDEPluginServiceClient {
  uploadURL(
    ...
    callback: (
      ...
      response: ideplugin_pb.PluginUploadURLResponse
    ) => void
  ...
  downloadURL(
    ...
    callback: (
      error: grpc.ServiceError | null,
      response: ideplugin_pb.PluginDownloadURLResponse
    ) => void
  ): grpc.ClientUnaryCall;
  downloadURL(
    request: ideplugin_pb.PluginDownloadURLRequest,
  ...
  pluginHash(
    ...
    callback: (
      error: grpc.ServiceError | null,
      response: ideplugin_pb.PluginHashResponse
    ) => void
  ): grpc.ClientUnaryCall;
  pluginHash(
    request: ideplugin_pb.PluginHashRequest,
...
export class IDEPluginServiceClient
  extends grpc.Client
  implements IIDEPluginServiceClient
{
  constructor(
    address: string,
