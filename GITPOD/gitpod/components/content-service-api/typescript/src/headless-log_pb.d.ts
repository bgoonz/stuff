...
export class LogDownloadURLRequest extends jspb.Message {
  ...
  static toObject(
    ...
    msg: LogDownloadURLRequest
  ): LogDownloadURLRequest.AsObject;
...
export class LogDownloadURLResponse extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: LogDownloadURLResponse
  ): LogDownloadURLResponse.AsObject;
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
  static extensionsBinary: {
    [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>;
  };
...
export class ListLogsResponse extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: ListLogsResponse
  ): ListLogsResponse.AsObject;
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
  static extensionsBinary: {
    [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>;
  };
