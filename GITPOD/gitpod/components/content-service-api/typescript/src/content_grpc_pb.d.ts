...
interface IContentServiceService
...
interface IContentServiceService_IDeleteUserContent
  extends grpc.MethodDefinition<
    content_pb.DeleteUserContentRequest,
    content_pb.DeleteUserContentResponse
  > {
...
export interface IContentServiceServer
  ...
  deleteUserContent: grpc.handleUnaryCall<
    content_pb.DeleteUserContentRequest,
    content_pb.DeleteUserContentResponse
  >;
}
...
export interface IContentServiceClient {
  deleteUserContent(
    ...
    callback: (
      ...
      response: content_pb.DeleteUserContentResponse
    ) => void
...
export class ContentServiceClient
  extends grpc.Client
  implements IContentServiceClient
{
  constructor(
    address: string,
