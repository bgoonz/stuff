...
interface IWorkspaceServiceService
...
interface IWorkspaceServiceService_IDeleteWorkspace
  extends grpc.MethodDefinition<
    workspace_pb.DeleteWorkspaceRequest,
    workspace_pb.DeleteWorkspaceResponse
  > {
...
export interface IWorkspaceServiceServer
  ...
  workspaceDownloadURL: grpc.handleUnaryCall<
    ...
    workspace_pb.WorkspaceDownloadURLResponse
  >;
  deleteWorkspace: grpc.handleUnaryCall<
    workspace_pb.DeleteWorkspaceRequest,
    workspace_pb.DeleteWorkspaceResponse
  >;
}
...
export interface IWorkspaceServiceClient {
  workspaceDownloadURL(
    ...
    callback: (
      ...
      response: workspace_pb.WorkspaceDownloadURLResponse
    ) => void
  ...
  deleteWorkspace(
    ...
    callback: (
      error: grpc.ServiceError | null,
      response: workspace_pb.DeleteWorkspaceResponse
    ) => void
  ): grpc.ClientUnaryCall;
  deleteWorkspace(
    request: workspace_pb.DeleteWorkspaceRequest,
...
export class WorkspaceServiceClient
  extends grpc.Client
  implements IWorkspaceServiceClient
{
  constructor(
    address: string,
