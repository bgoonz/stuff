...
interface IWorkspaceContentServiceService
...
interface IWorkspaceContentServiceService_IInitWorkspace
  extends grpc.MethodDefinition<
    daemon_pb.InitWorkspaceRequest,
    daemon_pb.InitWorkspaceResponse
  > {
...
interface IWorkspaceContentServiceService_IWaitForInit
  extends grpc.MethodDefinition<
    daemon_pb.WaitForInitRequest,
    daemon_pb.WaitForInitResponse
  > {
...
interface IWorkspaceContentServiceService_IDisposeWorkspace
  extends grpc.MethodDefinition<
    daemon_pb.DisposeWorkspaceRequest,
    daemon_pb.DisposeWorkspaceResponse
  > {
...
export interface IWorkspaceContentServiceServer
  ...
  initWorkspace: grpc.handleUnaryCall<
    daemon_pb.InitWorkspaceRequest,
    daemon_pb.InitWorkspaceResponse
  >;
  waitForInit: grpc.handleUnaryCall<
    daemon_pb.WaitForInitRequest,
    daemon_pb.WaitForInitResponse
  >;
  takeSnapshot: grpc.handleUnaryCall<
    ...
    daemon_pb.TakeSnapshotResponse
  >;
  disposeWorkspace: grpc.handleUnaryCall<
    daemon_pb.DisposeWorkspaceRequest,
    daemon_pb.DisposeWorkspaceResponse
  >;
}
...
export interface IWorkspaceContentServiceClient {
  initWorkspace(
    ...
    callback: (
      ...
      response: daemon_pb.InitWorkspaceResponse
    ) => void
  ...
  waitForInit(
    ...
    callback: (
      error: grpc.ServiceError | null,
      response: daemon_pb.WaitForInitResponse
    ) => void
  ): grpc.ClientUnaryCall;
  waitForInit(
    request: daemon_pb.WaitForInitRequest,
  ...
  takeSnapshot(
    ...
    callback: (
      error: grpc.ServiceError | null,
      response: daemon_pb.TakeSnapshotResponse
    ) => void
  ): grpc.ClientUnaryCall;
  takeSnapshot(
    request: daemon_pb.TakeSnapshotRequest,
  ...
  disposeWorkspace(
    ...
    callback: (
      error: grpc.ServiceError | null,
      response: daemon_pb.DisposeWorkspaceResponse
    ) => void
  ): grpc.ClientUnaryCall;
  disposeWorkspace(
    request: daemon_pb.DisposeWorkspaceRequest,
...
export class WorkspaceContentServiceClient
  extends grpc.Client
  implements IWorkspaceContentServiceClient
{
  constructor(
    address: string,
