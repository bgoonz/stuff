...
function deserialize_iws_MountProcRequest(buffer_arg) {
  return workspace_daemon_pb.MountProcRequest.deserializeBinary(
...
function deserialize_iws_MountProcResponse(buffer_arg) {
  return workspace_daemon_pb.MountProcResponse.deserializeBinary(
    new Uint8Array(buffer_arg)
  );
}
...
function deserialize_iws_PrepareForUserNSRequest(buffer_arg) {
  return workspace_daemon_pb.PrepareForUserNSRequest.deserializeBinary(
    new Uint8Array(buffer_arg)
  );
}
...
function deserialize_iws_PrepareForUserNSResponse(buffer_arg) {
  return workspace_daemon_pb.PrepareForUserNSResponse.deserializeBinary(
    new Uint8Array(buffer_arg)
  );
}
...
function deserialize_iws_TeardownRequest(buffer_arg) {
  return workspace_daemon_pb.TeardownRequest.deserializeBinary(
    new Uint8Array(buffer_arg)
  );
}
...
function deserialize_iws_TeardownResponse(buffer_arg) {
  return workspace_daemon_pb.TeardownResponse.deserializeBinary(
    new Uint8Array(buffer_arg)
  );
}
...
function deserialize_iws_UmountProcRequest(buffer_arg) {
  return workspace_daemon_pb.UmountProcRequest.deserializeBinary(
    new Uint8Array(buffer_arg)
  );
}
...
function deserialize_iws_UmountProcResponse(buffer_arg) {
  return workspace_daemon_pb.UmountProcResponse.deserializeBinary(
    new Uint8Array(buffer_arg)
  );
}
...
function deserialize_iws_WriteIDMappingRequest(buffer_arg) {
  return workspace_daemon_pb.WriteIDMappingRequest.deserializeBinary(
    new Uint8Array(buffer_arg)
  );
}
...
exports.InWorkspaceServiceClient = grpc.makeGenericClientConstructor(
  InWorkspaceServiceService
);
