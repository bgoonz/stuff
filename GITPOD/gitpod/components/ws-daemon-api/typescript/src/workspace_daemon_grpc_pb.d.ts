...
interface IInWorkspaceServiceService
...
interface IInWorkspaceServiceService_IMountProc
  extends grpc.MethodDefinition<
    ...
    workspace_daemon_pb.MountProcResponse
  > {
...
interface IInWorkspaceServiceService_IUmountProc
  extends grpc.MethodDefinition<
    ...
    workspace_daemon_pb.UmountProcResponse
  > {
...
interface IInWorkspaceServiceService_ITeardown
  extends grpc.MethodDefinition<
    workspace_daemon_pb.TeardownRequest,
    workspace_daemon_pb.TeardownResponse
  > {
...
export interface IInWorkspaceServiceServer
  ...
  writeIDMapping: grpc.handleUnaryCall<
    ...
    workspace_daemon_pb.WriteIDMappingResponse
  >;
  mountProc: grpc.handleUnaryCall<
    workspace_daemon_pb.MountProcRequest,
    workspace_daemon_pb.MountProcResponse
  >;
  umountProc: grpc.handleUnaryCall<
    workspace_daemon_pb.UmountProcRequest,
    workspace_daemon_pb.UmountProcResponse
  >;
  mountSysfs: grpc.handleUnaryCall<
    workspace_daemon_pb.MountProcRequest,
    workspace_daemon_pb.MountProcResponse
  >;
  umountSysfs: grpc.handleUnaryCall<
    workspace_daemon_pb.UmountProcRequest,
    workspace_daemon_pb.UmountProcResponse
  >;
  teardown: grpc.handleUnaryCall<
    workspace_daemon_pb.TeardownRequest,
    workspace_daemon_pb.TeardownResponse
  >;
}
...
export interface IInWorkspaceServiceClient {
  prepareForUserNS(
    ...
    callback: (
      ...
      response: workspace_daemon_pb.PrepareForUserNSResponse
    ) => void
  ...
  writeIDMapping(
    ...
    callback: (
      error: grpc.ServiceError | null,
      response: workspace_daemon_pb.WriteIDMappingResponse
    ) => void
  ): grpc.ClientUnaryCall;
  writeIDMapping(
    request: workspace_daemon_pb.WriteIDMappingRequest,
  ...
  mountProc(
    ...
    callback: (
      error: grpc.ServiceError | null,
      response: workspace_daemon_pb.MountProcResponse
    ) => void
  ): grpc.ClientUnaryCall;
  mountProc(
    request: workspace_daemon_pb.MountProcRequest,
  ...
  umountProc(
    ...
    callback: (
      error: grpc.ServiceError | null,
      response: workspace_daemon_pb.UmountProcResponse
    ) => void
  ): grpc.ClientUnaryCall;
  umountProc(
    request: workspace_daemon_pb.UmountProcRequest,
  ...
  teardown(
    ...
    callback: (
      error: grpc.ServiceError | null,
      response: workspace_daemon_pb.TeardownResponse
    ) => void
  ): grpc.ClientUnaryCall;
  teardown(
    request: workspace_daemon_pb.TeardownRequest,
...
export class InWorkspaceServiceClient
  extends grpc.Client
  implements IInWorkspaceServiceClient
{
  constructor(
    address: string,
