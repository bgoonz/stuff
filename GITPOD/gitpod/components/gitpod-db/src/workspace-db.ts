...
export interface PrebuiltUpdatableAndWorkspace
  extends PrebuiltWorkspaceUpdatable {
...
export type WorkspaceInstancePortsAuthData = Pick<
  WorkspaceInstance,
  "id" | "region"
>;
...
export type WorkspaceInstanceSession = Pick<
  WorkspaceInstance,
  "id" | "startedTime" | "stoppingTime" | "stoppedTime"
>;
export type WorkspaceSessionData = Pick<
  Workspace,
  "id" | "contextURL" | "context" | "type"
>;
...
export type WorkspaceOwnerAndSoftDeleted = Pick<
  Workspace,
  "id" | "ownerId" | "softDeleted"
>;
...
export interface WorkspaceDB {
  ...
  findWorkspacePortsAuthDataById(
    workspaceId: string
  ...
  attachUpdatableToPrebuild(
    pwsid: string,
    update: PrebuiltWorkspaceUpdatable
  ): Promise<void>;
  findUpdatablesForPrebuild(
    pwsid: string
