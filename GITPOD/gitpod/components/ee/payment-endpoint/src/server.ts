...
export class Server {
  ...
  protected readonly chargebeeController: EndpointController;
  @inject(GithubEndpointController)
  protected readonly githubController: GithubEndpointController;
  @inject(GithubSubscriptionReconciler)
  protected readonly githubSubscriptionReconciler: GithubSubscriptionReconciler;
        ...
        .listen(port, () => {
          log.info(
            `Server listening on port: ${
              (<AddressInfo>httpServer.address()).port
            }`
          );
          resolve();
        })
