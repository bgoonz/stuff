...
exports.Subscription =
  exports.AssignedTeamSubscription =
  exports.UserPaidSubscription =
  exports.SessionDescription =
  exports.CreditDescription =
  exports.AccountEntry =
    void 0;
...
(function (CreditDescription) {
  ...
  (CreditDescription =
    exports.CreditDescription || (exports.CreditDescription = {}))
);
...
(function (SessionDescription) {
  ...
  (SessionDescription =
    exports.SessionDescription || (exports.SessionDescription = {}))
);
...
(function (UserPaidSubscription) {
  ...
  (UserPaidSubscription =
    exports.UserPaidSubscription || (exports.UserPaidSubscription = {}))
);
...
(function (AssignedTeamSubscription) {
  ...
  (AssignedTeamSubscription =
    exports.AssignedTeamSubscription || (exports.AssignedTeamSubscription = {}))
);
var Subscription;
(function (Subscription) {
  ...
  function calculateCurrentPeriod(startDate, now) {
    ...
    do {
      ...
      nextStartDate = timeutil_1.oneMonthLater(
        startDate,
