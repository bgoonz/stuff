...
exports.createWindowMessageConnection =
  exports.WindowMessageReader =
  exports.WindowMessageWriter =
    void 0;
...
var WindowMessageWriter = /** @class */ (function (_super) {
  ...
  WindowMessageWriter.prototype.write = function (msg) {
    ...
    this.window.postMessage(
      Object.assign(msg, { serviceId: serviceId }),
      this.targetOrigin
    );
  };
  ...
  function WindowMessageReader(serviceId, sourceOrigin) {
    ...
    window.addEventListener(
      ...
      function (event) {
        ...
        if (
          !isWindowMessage(event.data) ||
          event.data.serviceId !== _this.serviceId
        ) {
          return;
        }
        if (_this.callback) {
...
function createWindowMessageConnection(
  serviceId,
  window,
  sourceOrigin,
  targetOrigin
  ...
  return main_1.createMessageConnection(
    reader,
    writer,
    new vscode_ws_jsonrpc_1.ConsoleLogger()
  );
}
