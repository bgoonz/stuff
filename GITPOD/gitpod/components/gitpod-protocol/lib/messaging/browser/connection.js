...
var WebSocketConnectionProvider = /** @class */ (function () {
   ...
   */
  WebSocketConnectionProvider.prototype.createProxy = function (
    path,
    target,
    options
  ) {
      ...
      var socket = _this.listen(
        {
          ...
          onConnection: function (c) {
            return factory.listen(c);
          },
        },
        options
      );
      if (
        options === null || options === void 0 ? void 0 : options.onListening
      ) {
