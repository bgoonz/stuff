...
(function (WorkspaceAndInstance) {
    function toWorkspace(wai) {
        return __assign({ id: wai.workspaceId, creationTime: wai.workspaceCreationTime }, wai);
    }
    ...
    function toInstance(wai) {
        ...
        return __assign({ id: wai.instanceId, creationTime: wai.instanceCreationTime }, wai);
    }
    WorkspaceAndInstance.toInstance = toInstance;
})(WorkspaceAndInstance = exports.WorkspaceAndInstance || (exports.WorkspaceAndInstance = {}));
