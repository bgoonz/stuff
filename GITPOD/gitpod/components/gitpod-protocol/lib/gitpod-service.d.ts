...
import { Team, TeamMemberInfo, TeamMembershipInvite, Project, PrebuildInfo, TeamMemberRole } from './teams-projects-protocol';
...
export declare const createServerMock: <C extends GitpodClient, S extends GitpodServer>(methods: Partial<JsonRpcProxy<S>>) => JsonRpcProxy<S>;
declare type WorkspaceTimeoutDurationTuple = typeof WorkspaceTimeoutValues;
export declare type WorkspaceTimeoutDuration = WorkspaceTimeoutDurationTuple[number];
...
export declare class GitpodCompositeClient<Client extends GitpodClient> implements GitpodClient {
