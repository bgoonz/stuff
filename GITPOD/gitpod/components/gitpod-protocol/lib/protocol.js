...
exports.TheiaPlugin =
  exports.AuthProviderEntry =
  exports.WorkspaceCreationResult =
  exports.CreateWorkspaceMode =
  exports.WorkspaceInfo =
  exports.WorkspaceInstancePortsChangedEvent =
  exports.Repository =
  exports.NavigatorContext =
  exports.IssueContext =
  exports.PullRequestContext =
  exports.CommitContext =
  exports.AdditionalContentContext =
  exports.RefType =
  exports.WorkspaceProbeContext =
  exports.WithEnvvarsContext =
  exports.PrebuiltWorkspaceContext =
  exports.StartPrebuildContext =
  exports.SnapshotContext =
  exports.WithDefaultConfig =
  exports.WithPrebuild =
  exports.WithSnapshot =
  exports.WorkspaceContext =
  exports.ExternalImageConfigFile =
  exports.ImageConfigFile =
  exports.ImageConfigString =
  exports.WorkspaceImageBuild =
  exports.TaskConfig =
  exports.PortRangeConfig =
  exports.PortConfig =
  exports.PrebuiltWorkspace =
  exports.WorkspaceImageSourceReference =
  exports.WorkspaceImageSourceDocker =
  exports.GithubAppPrebuildConfig =
  exports.Workspace =
  exports.Identity =
  exports.GitpodTokenType =
  exports.UserEnvVar =
...
(function (User) {
  function is(data) {
    return (
      data && data.hasOwnProperty("id") && data.hasOwnProperty("identities")
    );
  }
  User.is = is;
  function getIdentity(user, authProviderId) {
    return user.identities.find(function (id) {
      return id.authProviderId === authProviderId;
    });
  }
  ...
  function getPrimaryEmail(user) {
    var identities = user.identities.filter(function (i) {
      return !!i.primaryEmail;
    });
    if (identities.length <= 0) {
      throw new Error(
        "No identity with primary email for user: " + user.id + "!"
      );
    }
  ...
  function getName(user) {
    ...
    try {
      for (
        var _b = __values(user.identities), _c = _b.next();
        !_c.done;
        _c = _b.next()
      ) {
        var id = _c.value;
...
(function (UserEnvVar) {
  ...
  function score(value) {
    ...
    var _a = __read(splitRepositoryPattern(value.repositoryPattern), 2),
      ownerPattern = _a[0],
      repoPattern = _a[1];
    var score = 0;
    if (repoPattern == "*") {
  ...
  function filter(vars, owner, repo) {
    ...
    var result = vars.filter(function (e) {
      var _a = __read(splitRepositoryPattern(e.repositoryPattern), 2),
        ownerPattern = _a[0],
        repoPattern = _a[1];
      if (
        ownerPattern !== "*" &&
        ownerPattern !== "#" &&
        !!owner &&
        ownerPattern !== owner.toLocaleLowerCase()
      ) {
        return false;
      }
      if (
        ...
        repoPattern !== "#" &&
        !!repo &&
        repoPattern !== repo.toLocaleLowerCase()
      ) {
        return false;
      }
      return true;
    ...
    try {
      for (
        var _c = __values(resmap.keys()), _d = _c.next();
        !_d.done;
        _d = _c.next()
      ) {
        var name_1 = _d.value;
        ...
        try {
          for (
            var candidates_1 = ((e_3 = void 0), __values(candidates)),
...
(function (GitpodTokenType) {
  ...
  GitpodTokenType[(GitpodTokenType["MACHINE_AUTH_TOKEN"] = 1)] =
    "MACHINE_AUTH_TOKEN";
})(
...
(function (Identity) {
  function is(data) {
    return (
      data.hasOwnProperty("authProviderId") &&
  ...
  function equals(id1, id2) {
    return (
      id1.authProviderId === id2.authProviderId && id1.authId === id2.authId
    );
  }
...
(function (Workspace) {
  ...
  function getFullRepositoryUrl(ws) {
    if (CommitContext.is(ws.context)) {
      return (
        "https://" +
        ws.context.repository.host +
        "/" +
        getFullRepositoryName(ws)
      );
    }
    return undefined;
  }
...
(function (GithubAppPrebuildConfig) {
  ...
  (GithubAppPrebuildConfig =
    exports.GithubAppPrebuildConfig || (exports.GithubAppPrebuildConfig = {}))
);
...
(function (PrebuiltWorkspace) {
  ...
  (PrebuiltWorkspace =
    exports.PrebuiltWorkspace || (exports.PrebuiltWorkspace = {}))
);
var PortConfig;
(function (PortConfig) {
  function is(config) {
...
(function (PortRangeConfig) {
  function is(config) {
    return (
      config &&
      "port" in config &&
      (typeof config.port === "string" || config.port instanceof String)
    );
  }
...
(function (TaskConfig) {
  function is(config) {
    return (
      config && ("command" in config || "init" in config || "before" in config)
    );
  }
  TaskConfig.is = is;
...
(function (WorkspaceImageBuild) {
  ...
  (function (LogLine) {
    ...
    (LogLine =
      WorkspaceImageBuild.LogLine || (WorkspaceImageBuild.LogLine = {}))
  );
})(
  (WorkspaceImageBuild =
    exports.WorkspaceImageBuild || (exports.WorkspaceImageBuild = {}))
);
...
(function (ImageConfigString) {
  ...
  (ImageConfigString =
    exports.ImageConfigString || (exports.ImageConfigString = {}))
);
var ImageConfigFile;
...
(function (ExternalImageConfigFile) {
  ...
  (ExternalImageConfigFile =
    exports.ExternalImageConfigFile || (exports.ExternalImageConfigFile = {}))
);
...
(function (WorkspaceContext) {
  ...
  (WorkspaceContext =
    exports.WorkspaceContext || (exports.WorkspaceContext = {}))
);
var WithSnapshot;
...
(function (WithDefaultConfig) {
  function is(context) {
    return (
      context && "withDefaultConfig" in context && context.withDefaultConfig
    );
  }
  ...
  (WithDefaultConfig =
    exports.WithDefaultConfig || (exports.WithDefaultConfig = {}))
);
var SnapshotContext;
...
(function (StartPrebuildContext) {
  ...
  (StartPrebuildContext =
    exports.StartPrebuildContext || (exports.StartPrebuildContext = {}))
);
var PrebuiltWorkspaceContext;
(function (PrebuiltWorkspaceContext) {
  function is(context) {
    return (
      context && "originalContext" in context && "prebuiltWorkspace" in context
    );
  }
  PrebuiltWorkspaceContext.is = is;
})(
  (PrebuiltWorkspaceContext =
    exports.PrebuiltWorkspaceContext || (exports.PrebuiltWorkspaceContext = {}))
);
...
(function (WithEnvvarsContext) {
  ...
  (WithEnvvarsContext =
    exports.WithEnvvarsContext || (exports.WithEnvvarsContext = {}))
);
...
(function (WorkspaceProbeContext) {
  ...
  (WorkspaceProbeContext =
    exports.WorkspaceProbeContext || (exports.WorkspaceProbeContext = {}))
);
var RefType;
(function (RefType) {
...
(function (AdditionalContentContext) {
  ...
  function hasDockerConfig(ctx, config) {
    return (
      ...
      !!ctx.additionalFiles[config.image.file]
    );
  }
  AdditionalContentContext.hasDockerConfig = hasDockerConfig;
})(
  (AdditionalContentContext =
    exports.AdditionalContentContext || (exports.AdditionalContentContext = {}))
);
var CommitContext;
(function (CommitContext) {
  function is(commit) {
    return (
      WorkspaceContext.is(commit) &&
...
(function (PullRequestContext) {
  function is(ctx) {
    return (
      CommitContext.is(ctx) && "nr" in ctx && "ref" in ctx && "base" in ctx
    );
  }
  PullRequestContext.is = is;
})(
  (PullRequestContext =
    exports.PullRequestContext || (exports.PullRequestContext = {}))
);
var IssueContext;
(function (IssueContext) {
  function is(ctx) {
    return (
      CommitContext.is(ctx) &&
      "nr" in ctx &&
      "ref" in ctx &&
      "localBranch" in ctx
    );
...
(function (NavigatorContext) {
  ...
  (NavigatorContext =
    exports.NavigatorContext || (exports.NavigatorContext = {}))
);
var Repository;
(function (Repository) {
...
(function (WorkspaceInstancePortsChangedEvent) {
  ...
  (WorkspaceInstancePortsChangedEvent =
    exports.WorkspaceInstancePortsChangedEvent ||
    (exports.WorkspaceInstancePortsChangedEvent = {}))
);
var WorkspaceInfo;
(function (WorkspaceInfo) {
  function lastActiveISODate(info) {
    var _a;
    return (
      ((_a = info.latestInstance) === null || _a === void 0
        ? void 0
        : _a.creationTime) || info.workspace.creationTime
    );
  }
...
(function (CreateWorkspaceMode) {
  ...
  (CreateWorkspaceMode =
    exports.CreateWorkspaceMode || (exports.CreateWorkspaceMode = {}))
);
...
(function (WorkspaceCreationResult) {
  ...
  (WorkspaceCreationResult =
    exports.WorkspaceCreationResult || (exports.WorkspaceCreationResult = {}))
);
var AuthProviderEntry;
(function (AuthProviderEntry) {
  function redact(entry) {
    return __assign(__assign({}, entry), {
      oauth: __assign(__assign({}, entry.oauth), { clientSecret: "redacted" }),
    });
  }
  AuthProviderEntry.redact = redact;
})(
  (AuthProviderEntry =
    exports.AuthProviderEntry || (exports.AuthProviderEntry = {}))
);
var TheiaPlugin;
