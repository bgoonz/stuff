...
export declare type WorkspaceClusterState =
  | "available"
  | "cordoned"
  | "draining";
...
export declare type WorkspaceManagerConnectionInfo = Pick<
  WorkspaceCluster,
  "name" | "url" | "tls"
>;
export declare type AdmissionConstraint =
...
export interface WorkspaceClusterDB {
   ...
   */
  findFiltered(
    predicate: DeepPartial<WorkspaceClusterFilter>
  ): Promise<WorkspaceClusterWoTLS[]>;
}
export interface WorkspaceClusterFilter
  extends Pick<WorkspaceCluster, "state" | "govern" | "url"> {
  minScore: number;
}
