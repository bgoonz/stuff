...
export declare type NamedWorkspaceFeatureFlag =
  keyof typeof WorkspaceFeatureFlags;
...
export declare namespace UserEnvVar {
  ...
  function filter<T extends UserEnvVarValue>(
    vars: T[],
    owner: string,
    repo: string
  ): T[];
...
export declare type IdentityLookup = Pick<
  Identity,
...
export declare type AppInstallationState =
  | "claimed.user"
  | "claimed.platform"
  | "installed"
  | "uninstalled";
...
export declare type WorkspaceImageSource =
...
export declare type PrebuiltWorkspaceState =
  | "queued"
  | "building"
  | "aborted"
  | "timeout"
...
export declare namespace AuthProviderEntry {
  ...
  type UpdateEntry = Pick<AuthProviderEntry, "id" | "ownerId"> &
