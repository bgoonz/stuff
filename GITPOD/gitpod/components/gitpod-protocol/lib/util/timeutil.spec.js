...
var TimeutilSpec = /** @class */ (function () {
  ...
  TimeutilSpec.prototype.isOneMonthLater = function (from, day, expectation) {
    ...
    expect(
      later,
      "expected " + later + " to be equal " + expectation
    ).to.be.equal(expectation.toISOString());
  };
  __decorate(
    [
    ...
    TimeutilSpec.prototype,
    "testTimeutil",
    null
  );
  TimeutilSpec = __decorate([mocha_typescript_1.suite()], TimeutilSpec);
  return TimeutilSpec;
})();
