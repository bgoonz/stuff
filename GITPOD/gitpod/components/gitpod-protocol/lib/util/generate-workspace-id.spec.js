...
var TestGenerateWorkspaceId = /** @class */ (function () {
    ...
    TestGenerateWorkspaceId.prototype.testLongestName = function () {
        var longestColor = generate_workspace_id_1.colors.sort(function (a, b) { return b.length - a.length; })[0];
        var longestAnimal = generate_workspace_id_1.animals.sort(function (a, b) { return b.length - a.length; })[0];
