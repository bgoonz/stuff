...
var ParseWorkspaceIdTest = /** @class */ (function () {
  ...
  ParseWorkspaceIdTest.prototype.parseWorkspaceIdFromHostname_fromWorkspaceLocation =
    function () {
      var actual = parse_workspace_id_1.parseWorkspaceIdFromHostname(
        "moccasin-ferret-155799b3.ws-eu01.gitpod.io"
      );
      expect(actual).to.equal("moccasin-ferret-155799b3");
    };
  ParseWorkspaceIdTest.prototype.parseWorkspaceIdFromHostname_fromWorkspacePortLocation =
    function () {
      var actual = parse_workspace_id_1.parseWorkspaceIdFromHostname(
        "3000-moccasin-ferret-155799b3.ws-eu01.gitpod.io"
      );
      expect(actual).to.equal("moccasin-ferret-155799b3");
    };
  ParseWorkspaceIdTest.prototype.parseWorkspaceIdFromHostname_fromWorkspacePortLocationWithWebviewPrefix =
    function () {
      var actual = parse_workspace_id_1.parseWorkspaceIdFromHostname(
        "webview-3000-moccasin-ferret-155799b3.ws-eu01.gitpod.io"
      );
      expect(actual).to.equal("moccasin-ferret-155799b3");
    };
  ParseWorkspaceIdTest.prototype.parseWorkspaceIdFromHostname_fromWorkspacePortLocationWithWebviewPrefixCustomHost =
    function () {
      var actual = parse_workspace_id_1.parseWorkspaceIdFromHostname(
  ...
  // legacy mode
  ParseWorkspaceIdTest.prototype.parseLegacyWorkspaceIdFromHostname_fromWorkspaceLocation =
    function () {
      var actual = parse_workspace_id_1.parseWorkspaceIdFromHostname(
  ...
  ParseWorkspaceIdTest.prototype.parseLegacyWorkspaceIdFromHostname_fromWorkspacePortLocation =
    function () {
      var actual = parse_workspace_id_1.parseWorkspaceIdFromHostname(
        "3000-b7e0eaf8-ec73-44ec-81ea-04859263b656.ws-eu01.gitpod.io"
      );
      expect(actual).to.equal("b7e0eaf8-ec73-44ec-81ea-04859263b656");
    };
  ParseWorkspaceIdTest.prototype.parseLegacyWorkspaceIdFromHostname_fromWorkspacePortLocationWithWebviewPrefix =
    function () {
      var actual = parse_workspace_id_1.parseWorkspaceIdFromHostname(
  ...
  ParseWorkspaceIdTest.prototype.parseLegacyWorkspaceIdFromHostname_fromWorkspacePortLocationWithWebviewPrefixCustomHost =
    function () {
      var actual = parse_workspace_id_1.parseWorkspaceIdFromHostname(
  ...
  __decorate(
    ...
    ParseWorkspaceIdTest.prototype,
