...
exports.PerOperationSampler =
  exports.TracingManager =
...
var TracingManager = /** @class */ (function () {
  ...
  TracingManager = __decorate([inversify_1.injectable()], TracingManager);
...
var PerOperationSampler = /** @class */ (function () {
  ...
  PerOperationSampler.prototype.onSetOperationName = function (
    span,
    operationName
  ) {
    var outTags = {};
