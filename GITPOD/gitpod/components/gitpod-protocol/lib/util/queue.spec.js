...
var QueueSpec = /** @class */ (function () {
  ...
  QueueSpec.prototype.expectArray = function (actual, expected) {
    ...
    try {
      for (
        var actual_1 = __values(actual), actual_1_1 = actual_1.next();
        !actual_1_1.done;
        actual_1_1 = actual_1.next()
      ) {
        var act = actual_1_1.value;
        var _b = __read(expIt.next().value, 2),
          exp = _b[1];
      ...
      try {
        if (actual_1_1 && !actual_1_1.done && (_a = actual_1.return))
          _a.call(actual_1);
      } finally {
  ...
  QueueSpec = __decorate([mocha_typescript_1.suite], QueueSpec);
  return QueueSpec;
})();
