...
exports.hoursToMilliseconds =
  exports.millisecondsToHours =
  exports.rightBefore =
  exports.rightAfter =
  exports.secondsBefore =
  exports.hoursLater =
  exports.liftDate =
  exports.liftDate1 =
  exports.orderAsc =
  exports.earliest =
  exports.oldest =
  exports.isDateSmaller =
  exports.isDateSmallerOrEqual =
  exports.isDateGreaterOrEqual =
  exports.durationInMillis =
  exports.durationInHours =
  exports.addMillis =
  exports.yearsLater =
...
var yearsLater = function (fromDate, years) {
  return exports.liftDate1(fromDate, function (d) {
...
var addMillis = function (d1, millis) {
  return exports.liftDate1(d1, function (d1) {
    return new Date(d1.getTime() + millis).toISOString();
  });
};
exports.addMillis = addMillis;
var durationInHours = function (d1, d2) {
  return exports.liftDate(d1, d2, function (d1, d2) {
    return millisecondsToHours(d1.getTime() - d2.getTime());
  });
};
exports.durationInHours = durationInHours;
var durationInMillis = function (d1, d2) {
  return exports.liftDate(d1, d2, function (d1, d2) {
...
// tslint:disable-next-line:no-shadowed-variable
var isDateGreaterOrEqual = function (d1, d2) {
  return exports.liftDate(d1, d2, function (d1, d2) {
    return d1.getTime() >= d2.getTime();
  });
};
exports.isDateGreaterOrEqual = isDateGreaterOrEqual;
var isDateSmallerOrEqual = function (d1, d2) {
  return !d2 || d1 <= d2;
};
exports.isDateSmallerOrEqual = isDateSmallerOrEqual;
var isDateSmaller = function (d1, d2) {
  return !d2 || d1 < d2;
};
exports.isDateSmaller = isDateSmaller;
var oldest = function (d1, d2) {
  return d1 > d2 ? d1 : d2;
};
exports.oldest = oldest;
var earliest = function (d1, d2) {
  return d1 < d2 ? d1 : d2;
};
exports.earliest = earliest;
var orderAsc = function (d1, d2) {
  return exports.liftDate(d1, d2, function (d1, d2) {
    return d1.getTime() - d2.getTime();
  });
};
exports.orderAsc = orderAsc;
var liftDate1 = function (d1, f) {
  return f(new Date(d1));
};
exports.liftDate1 = liftDate1;
var liftDate = function (d1, d2, f) {
  return f(new Date(d1), new Date(d2));
};
