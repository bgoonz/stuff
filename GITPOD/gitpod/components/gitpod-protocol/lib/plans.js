...
(function (Coupons) {
    ...
    Coupons.isGithubStudentCoupon = function (id) {
        var c = Coupons.getAllCoupons().find(function (ic) { return ic.id === id; });
        if (!c) {
            return undefined;
        }
    ...
    Coupons.getAllCoupons = function () {
        return Object.keys(Coupons)
            ...
            .filter(function (a) { return typeof a === 'object' && Coupon.is(a); });
    };
...
(function (Plans) {
    ...
    var getAllPlans = function () {
        return Object.keys(Plans)
            ...
            .filter(function (a) { return typeof a === 'object' && Plan.is(a); });
    };
    /**
    ...
    Plans.getAvailableTeamPlans = function (currency) {
        var teamPlans = getAllPlans().filter(function (p) { return !!p.team; });
    ...
    function getByTypeAndCurrency(type, currency) {
        return getAllPlans()
            .filter(function (p) { return p.type; })
            .find(function (p) { return p.currency === currency; });
    }
    ...
    function getPlanTypeArity(type) {
        return planStructure.findIndex(function (types) { return types.includes(type); });
    }
