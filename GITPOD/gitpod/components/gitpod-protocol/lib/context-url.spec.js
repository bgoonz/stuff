...
var ContextUrlTest = /** @class */ (function () {
    ...
    ContextUrlTest.prototype.parseContextUrl_withEnvVar = function () {
        var actual = context_url_1.ContextURL.parseToURL("passedin=test%20value/https://github.com/gitpod-io/gitpod-test-repo");
    ...
    ContextUrlTest.prototype.parseContextUrl_withEnvVar_withoutSchema = function () {
        var actual = context_url_1.ContextURL.parseToURL("passedin=test%20value/github.com/gitpod-io/gitpod-test-repo");
        expect(actual === null || actual === void 0 ? void 0 : actual.host).to.equal("github.com");
        expect(actual === null || actual === void 0 ? void 0 : actual.pathname).to.equal("/gitpod-io/gitpod-test-repo");
    };
    ContextUrlTest.prototype.parseContextUrl_withPrebuild = function () {
        var actual = context_url_1.ContextURL.parseToURL("prebuild/https://github.com/gitpod-io/gitpod-test-repo");
        expect(actual === null || actual === void 0 ? void 0 : actual.host).to.equal("github.com");
        expect(actual === null || actual === void 0 ? void 0 : actual.pathname).to.equal("/gitpod-io/gitpod-test-repo");
    };
    ContextUrlTest.prototype.parseContextUrl_withPrebuild_withoutSchema = function () {
        var actual = context_url_1.ContextURL.parseToURL("prebuild/github.com/gitpod-io/gitpod-test-repo");
        expect(actual === null || actual === void 0 ? void 0 : actual.host).to.equal("github.com");
        expect(actual === null || actual === void 0 ? void 0 : actual.pathname).to.equal("/gitpod-io/gitpod-test-repo");
    };
    __decorate([
