...
exports.createGitpodService =
  exports.GitpodServiceImpl =
  exports.WorkspaceInstanceUpdateListener =
  exports.GitpodCompositeClient =
  exports.GitpodServerProxy =
  exports.GitpodServerPath =
  exports.createServerMock =
  exports.createServiceMock =
  exports.WorkspaceTimeoutValues =
  exports.GitpodServer =
    void 0;
...
var GitpodCompositeClient = /** @class */ (function () {
  ...
  GitpodCompositeClient.prototype.onInstanceUpdate = function (instance) {
    ...
    try {
      for (
        var _b = __values(this.clients), _c = _b.next();
        !_c.done;
        _c = _b.next()
      ) {
        var client = _c.value;
  ...
  GitpodCompositeClient.prototype.onWorkspaceImageBuildLogs = function (
    info,
    content
  ) {
    var e_2, _a;
...
var WorkspaceInstanceUpdateListener = /** @class */ (function () {
  ...
  WorkspaceInstanceUpdateListener.prototype.sync = function () {
    ...
    this.syncQueue = this.syncQueue.then(function () {
      return __awaiter(_this, void 0, void 0, function () {
        var info, e_6;
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              return [
                4 /*yield*/,
                this.service.server.getWorkspace(this._info.workspace.id),
              ];
            case 2:
              info = _a.sent();
              if (token.isCancellationRequested) {
  ...
  WorkspaceInstanceUpdateListener.prototype.isOutOfOrder = function (instance) {
    ...
    if (
      instance.id !==
      ((_a = this.info.latestInstance) === null || _a === void 0
        ? void 0
        : _a.id)
    ) {
      return false;
    ...
    return (
      phasesOrder[instance.status.phase] <
      phasesOrder[this.info.latestInstance.status.phase]
    );
  };
...
var GitpodServiceImpl = /** @class */ (function () {
  function GitpodServiceImpl(server, options) {
    ...
    server.onDidOpenConnection(function () {
      return _this.compositeClient.notifyDidOpenConnection();
    });
    server.onDidCloseConnection(function () {
      return _this.compositeClient.notifyDidCloseConnection();
    });
  }
      ...
      (function () {
        return __awaiter(_this, void 0, void 0, function () {
          ...
          return __generator(this, function (_a) {
            switch (_a.label) {
              case 0:
                return [4 /*yield*/, this.server.getWorkspace(workspaceId)];
              case 1:
                info = _a.sent();
                return [
                  2 /*return*/,
                  new WorkspaceInstanceUpdateListener(this, info),
                ];
            }
          });
        });
...
function createGitpodService(serverUrl) {
  ...
  if (typeof serverUrl === "string") {
    ...
    url = serverUrl.then(function (url) {
      return toWsUrl(url);
    });
  }
