...
(function (TeamSubscription) {
  ...
  TeamSubscription.isActive = function (ts, date) {
    return (
      ts.startDate <= date && (ts.endDate === undefined || date < ts.endDate)
    );
  };
})(
  (TeamSubscription =
    exports.TeamSubscription || (exports.TeamSubscription = {}))
);
...
(function (TeamSubscriptionSlot) {
  ...
  TeamSubscriptionSlot.assign = function (
    slot,
    assigneeId,
    subscriptionId,
    assigneeIdentifier
  ...
  (TeamSubscriptionSlot =
    exports.TeamSubscriptionSlot || (exports.TeamSubscriptionSlot = {}))
);
