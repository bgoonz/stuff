...
export namespace Plans {
  ...
  export const getAvailableTeamPlans = (currency?: Currency): Plan[] => {
    ...
    return currency
      ? teamPlans.filter((p) => p.currency === currency)
      : teamPlans;
  };
  ...
  export function getByTypeAndCurrency(
    type: PlanType,
    currency: Currency
  ): Plan | undefined {
    return getAllPlans()
  ...
  export function isFreeNonTransientPlan(
   ...
   * @param plan
   */
  export function getParallelWorkspacesById(
