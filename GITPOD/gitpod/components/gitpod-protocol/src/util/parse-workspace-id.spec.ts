...
export class ParseWorkspaceIdTest {
  ...
  @test
  public parseWorkspaceIdFromHostname_fromWorkspacePortLocationWithWebviewPrefix() {
    const actual = parseWorkspaceIdFromHostname(
  ...
  @test
  public parseWorkspaceIdFromHostname_fromWorkspacePortLocationWithWebviewPrefixCustomHost() {
    const actual = parseWorkspaceIdFromHostname(
  ...
  @test
  public parseLegacyWorkspaceIdFromHostname_fromWorkspacePortLocationWithWebviewPrefix() {
    const actual = parseWorkspaceIdFromHostname(
  ...
  @test
  public parseLegacyWorkspaceIdFromHostname_fromWorkspacePortLocationWithWebviewPrefixCustomHost() {
    const actual = parseWorkspaceIdFromHostname(
