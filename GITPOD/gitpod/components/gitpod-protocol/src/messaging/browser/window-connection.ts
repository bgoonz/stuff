...
export class WindowMessageWriter
  ...
  implements MessageWriter
{
  ...
  write(msg: Message): void {
    ...
    this.window.postMessage(
      Object.assign(msg, { serviceId }),
      this.targetOrigin
    );
  }
}

export class WindowMessageReader
    ...
    window.addEventListener(
      ...
      (event) => {
        ...
        if (
          ...
          event.data.serviceId !== this.serviceId
        ) {
          return;
        }
        if (this.callback) {
