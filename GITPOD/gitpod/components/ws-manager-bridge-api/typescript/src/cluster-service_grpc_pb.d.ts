...
interface IClusterServiceService
...
interface IClusterServiceService_IRegister
  extends grpc.MethodDefinition<
    cluster_service_pb.RegisterRequest,
    cluster_service_pb.RegisterResponse
  > {
...
interface IClusterServiceService_IUpdate
  extends grpc.MethodDefinition<
    cluster_service_pb.UpdateRequest,
    cluster_service_pb.UpdateResponse
  > {
...
interface IClusterServiceService_IDeregister
  extends grpc.MethodDefinition<
    cluster_service_pb.DeregisterRequest,
    cluster_service_pb.DeregisterResponse
  > {
...
interface IClusterServiceService_IList
  extends grpc.MethodDefinition<
    cluster_service_pb.ListRequest,
    cluster_service_pb.ListResponse
  > {
...
export interface IClusterServiceServer
  ...
  update: grpc.handleUnaryCall<
    ...
    cluster_service_pb.UpdateResponse
  >;
  deregister: grpc.handleUnaryCall<
    cluster_service_pb.DeregisterRequest,
    cluster_service_pb.DeregisterResponse
  >;
...
export interface IClusterServiceClient {
  register(
    ...
    callback: (
      ...
      response: cluster_service_pb.RegisterResponse
    ) => void
  ...
  update(
    ...
    callback: (
      error: grpc.ServiceError | null,
      response: cluster_service_pb.UpdateResponse
    ) => void
  ): grpc.ClientUnaryCall;
  update(
    request: cluster_service_pb.UpdateRequest,
  ...
  deregister(
    ...
    callback: (
      error: grpc.ServiceError | null,
      response: cluster_service_pb.DeregisterResponse
    ) => void
  ): grpc.ClientUnaryCall;
  deregister(
    request: cluster_service_pb.DeregisterRequest,
  ...
  list(
    ...
    callback: (
      error: grpc.ServiceError | null,
      response: cluster_service_pb.ListResponse
    ) => void
  ): grpc.ClientUnaryCall;
  list(
    request: cluster_service_pb.ListRequest,
