...
interface IImageBuilderService
...
interface IImageBuilderService_IBuild
  extends grpc.MethodDefinition<
    imgbuilder_pb.BuildRequest,
    imgbuilder_pb.BuildResponse
  > {
...
interface IImageBuilderService_ILogs
  extends grpc.MethodDefinition<
    imgbuilder_pb.LogsRequest,
    imgbuilder_pb.LogsResponse
  > {
...
interface IImageBuilderService_IListBuilds
  extends grpc.MethodDefinition<
    imgbuilder_pb.ListBuildsRequest,
    imgbuilder_pb.ListBuildsResponse
  > {
...
export interface IImageBuilderServer extends grpc.UntypedServiceImplementation {
  ...
  resolveWorkspaceImage: grpc.handleUnaryCall<
    ...
    imgbuilder_pb.ResolveWorkspaceImageResponse
  >;
  build: grpc.handleServerStreamingCall<
    imgbuilder_pb.BuildRequest,
    imgbuilder_pb.BuildResponse
  >;
  logs: grpc.handleServerStreamingCall<
    imgbuilder_pb.LogsRequest,
    imgbuilder_pb.LogsResponse
  >;
  listBuilds: grpc.handleUnaryCall<
    imgbuilder_pb.ListBuildsRequest,
    imgbuilder_pb.ListBuildsResponse
  >;
}
...
export interface IImageBuilderClient {
  resolveBaseImage(
    ...
    callback: (
      ...
      response: imgbuilder_pb.ResolveBaseImageResponse
    ) => void
  ...
  resolveWorkspaceImage(
    ...
    callback: (
      error: grpc.ServiceError | null,
      response: imgbuilder_pb.ResolveWorkspaceImageResponse
    ) => void
  ): grpc.ClientUnaryCall;
  resolveWorkspaceImage(
    request: imgbuilder_pb.ResolveWorkspaceImageRequest,
  ...
  listBuilds(
    ...
    callback: (
      error: grpc.ServiceError | null,
      response: imgbuilder_pb.ListBuildsResponse
    ) => void
  ): grpc.ClientUnaryCall;
  listBuilds(
    request: imgbuilder_pb.ListBuildsRequest,
...
export class ImageBuilderClient
  extends grpc.Client
  implements IImageBuilderClient
{
  constructor(
    address: string,
