...
import {
  IDEFrontendService,
  IDEFrontendState,
} from "@gitpod/gitpod-protocol/lib/ide-frontend-service";
import {
  Disposable,
  DisposableCollection,
} from "@gitpod/gitpod-protocol/lib/util/disposable";
...
export function create(): IDEFrontendService {
  ...
  capabilities =
    (capabilitiesElementAttribute &&
      JSON.parse(capabilitiesElementAttribute)) ||
    capabilities;
