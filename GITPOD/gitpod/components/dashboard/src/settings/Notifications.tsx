...
export default function Notifications() {
  ...
  const [isTransactionalMail, setTransactionMail] = useState(
    !user?.additionalData?.emailNotificationSettings
      ?.disallowTransactionalEmails
  );
  ...
  const [isMarketingMail, setMarketingMail] = useState(
    !!user?.allowsMarketingCommunication
  );
