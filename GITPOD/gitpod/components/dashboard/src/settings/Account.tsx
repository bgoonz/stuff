    ...
    <div>
      ...
      >
        <ol className="text-gray-500 text-sm list-outside list-decimal">
          <li className="ml-5">
            All your workspaces and related data will be deleted and cannot be
            restored afterwards.
          </li>
          <li className="ml-5">
            Your subscription will be cancelled. If you obtained a Gitpod
            subscription through the GitHub marketplace, you need to cancel your
            plan there.
          </li>
        </ol>
      ...
      >
        ...
        <p className="text-base text-gray-500 pb-4 max-w-2xl">
          ...
          You can override git author name and email per project by using the
          default environment variables <CodeText>GIT_AUTHOR_NAME</CodeText> and{" "}
          ...
          <div>
            ...
            <div className="mt-4">
              ...
              <input
                type="text"
                disabled={true}
                value={User.getPrimaryEmail(user!)}
              />
            </div>
          </div>
        ...
        <p className="text-base text-gray-500 pb-4">
          This action will remove all the data associated with your account in
          Gitpod.
        </p>
