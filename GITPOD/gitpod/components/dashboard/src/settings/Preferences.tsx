    ...
    <div>
      ...
      >
        ...
        <AlertBox className="mt-3 mb-4 w-3/4">
          We're deprecating the Theia editor. You can still switch back to Theia
          for the next few weeks but the preference will be removed by the end
          of August 2021.
        </AlertBox>
        <div className="mt-4 space-x-4 flex">
          <SelectableCard
            className="w-36 h-40"
            title="VS Code"
            selected={defaultIde === "code"}
            onClick={() => actuallySetDefaultIde("code")}
          >
          ...
          <SelectableCard
            className="w-36 h-40"
            title="Theia"
            selected={defaultIde === "theia"}
            onClick={() => actuallySetDefaultIde("theia")}
          >
            <div className="flex-grow flex justify-center items-center">
