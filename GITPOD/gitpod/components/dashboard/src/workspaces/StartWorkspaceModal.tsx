...
export function StartWorkspaceModal(p: StartWorkspaceModalProps) {
  const computeSelection = () =>
    p.selected || (p.recent.length > 0 ? "Recent" : "Examples");
        ...
        <div className="space-y-2 mt-4 overflow-y-scroll h-80 pr-2">
          {list.length > 0 ? (
            ...
            <div className="flex flex-col pt-10 items-center px-2">
              ...
              <p className="text-center">
                Prefix a git repository URL with gitpod.io/# or start with an
                example.
              </p>
              <button
                onClick={() => setSelection("Examples")}
            ...
            <div className="flex flex-col pt-10 items-center px-2">
              ...
              <p className="text-center">
                Sorry there seem to be no example projects, that work with your
