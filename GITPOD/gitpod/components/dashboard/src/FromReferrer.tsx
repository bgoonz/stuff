      ...
      <div className="px-6 py-3 flex justify-between space-x-2 text-gray-400 h-96">
        <div className="flex flex-col items-center w-96 m-auto mt-40">
          ...
          <div className="text-center pb-6 text-gray-500">
            <p>
              It looks like you are trying to open a workspace, but the referrer
              URL is empty or has an incomplete path. This happens when the git
              hoster or browser doesn't send the referrer header.
              <br /> Please prefix the repository URL with{" "}
              <pre>https://gitpod.io/#</pre> in order to start a workspace.{" "}
              <a
                className="gp-link"
