...
function Item(props: { icon: string; iconSize?: string; text: string }) {
  ...
  return (
    <div className="flex-col items-center w-1/3 px-3">
      ...
      <div className="text-gray-400 text-sm w-36 h-20 text-center">
        {props.text}
      </div>
    </div>
  );
  ...
  return (
    <div id="login-container" className="z-50 flex w-screen h-screen">
      {showWelcome ? (
        <div
          id="feature-section"
          className="flex-grow bg-gray-100 dark:bg-gray-800 w-1/2 hidden lg:block"
        >
          <div
            id="feature-section-column"
            className="flex max-w-xl h-full mx-auto pt-6"
          >
            <div className="flex flex-col px-8 my-auto ml-auto">
              ...
              <div className="flex">
                <Item
                  icon={prebuild}
                  text="Continuously Prebuild Your Project"
                />
      ...
      <div
        id="login-section"
        className={"flex-grow flex w-full" + (showWelcome ? " lg:w-1/2" : "")}
      >
        <div
          id="login-section-column"
          className={
            "flex-grow max-w-2xl flex flex-col h-100 mx-auto" +
            (showWelcome ? " lg:my-0" : "")
          }
        >
