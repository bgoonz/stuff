...
export default function PendingChangesDropdown(props: {
  ...
  if (totalChanges <= 0) {
    return (
      <div className="text-sm text-gray-400 dark:text-gray-500">No Changes</div>
    );
  }
  return (
    <ContextMenu
      menuEntries={menuEntries}
      classes="w-64 max-h-48 overflow-scroll mx-auto left-0 right-0"
    >
