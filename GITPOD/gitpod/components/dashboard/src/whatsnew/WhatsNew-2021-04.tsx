    ...
    <>
      <div className="border-t border-gray-200 dark:border-gray-800 -mx-6 px-6 py-4">
        ...
        <p className="pb-2 text-gray-500 dark:text-gray-400 text-sm">
          We have made some layout changes on the dashboard to improve the
          overall user experience of Gitpod.
        </p>
      </div>
          ...
          <li className="ml-5">
            <div>
              <p className="text-gray-500 dark:text-gray-400 text-sm">
                We're preserving most{" "}
                <span className="font-bold">user settings and extensions</span>.
              </p>
              <p className="text-gray-400 dark:text-gray-500 text-sm">
                Extensions you have manually uploaded are not transferred.
                You'll need to search and install those extensions through the
          ...
          <li className="ml-5">
            <div>
              <p className="text-gray-500 dark:text-gray-400 text-sm">
                ...
                <span className="font-bold">pre-installed extensions</span>.
              </p>
              <p className="text-gray-400 dark:text-gray-500 text-sm">
                The Theia-based editor included pre-installed extensions for the
                most popular programming languages which was convenient for
                starters but added additional bloat. You can now install any
                extensions you need and leave out those you don't.
              </p>
            </div>
          </li>
          <li className="ml-5">
            <div>
              <p className="text-gray-500 dark:text-gray-400 text-sm">
                You can still <span className="font-bold">switch the IDE</span>{" "}
                back to Theia.
              </p>
              <p className="text-gray-400 dark:text-gray-500 text-sm">
                In case you run into trouble with VS Code, you can go to the
                settings and switch back to the Theia.
              </p>
            </div>
          </li>
        </ol>
