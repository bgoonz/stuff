      ...
      <>
        <div className="border-t border-b border-gray-200 dark:border-gray-800 -mx-6 px-6 pt-6 pb-4">
          ...
          <p className="pb-2 text-gray-500 dark:text-gray-400 text-sm">
            We've changed the default behavior of exposed ports to improve the
            security of your dev environments.
          </p>
          <p className="pb-2 text-gray-500 dark:text-gray-400 text-sm">
            Exposing ports are now private by default. You can still change port
            visibility through the editor or even configure this with the{" "}
            <CodeText>visibility</CodeText> property in{" "}
        ...
        {user.additionalData?.ideSettings?.defaultIde !== "code" && (
          <>
            <div className="border-b border-gray-200 dark:border-gray-800 -mx-6 px-6 pt-6 pb-4">
              <p className="pb-2 text-gray-900 dark:text-gray-100 text-base font-medium">
                New Editor{" "}
                <PillLabel type="warn">Deprecation Warning</PillLabel>
              </p>
              <p className="pb-2 text-gray-500 dark:text-gray-400 text-sm">
                We're deprecating the Theia editor. You can still switch back to
                Theia for the next few weeks but the preference will be removed
