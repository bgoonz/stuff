  ...
  return (
    <div className="flex flex-col w-96 mt-24 mx-auto items-center">
      ...
      <p className="text-gray-500 text-center text-base">
        Teams allow you to <strong>group multiple projects</strong>,{" "}
        <strong>collaborate with others</strong>,{" "}
        <strong>manage subscriptions</strong> with one centralized billing, and
        more.{" "}
        <a className="gp-link" href="https://www.gitpod.io/docs/teams/">
          Learn more
        </a>
      </p>
        ...
        <div className="border rounded-xl p-6 border-gray-100 dark:border-gray-800">
          ...
          {!!creationError && (
            <p className="text-gitpod-red">
              {creationError.message.replace(
                /Request \w+ failed with message: /,
                ""
              )}
            </p>
          )}
