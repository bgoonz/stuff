          ...
          statusMessage = (
            <div className="text-center">
              <p className="text-base mt-2">
                ...
                <a
                  className="text-blue"
                  href="https://www.gitpod.io/docs/context-urls/"
                >
                  supported context URLs
                </a>
              </p>
            </div>
          );
...
function LimitReachedPrivateRepoModal() {
  return (
    <LimitReachedModal>
      <p className="mt-1 mb-2 text-base">
        Gitpod is free for public repositories. To work with private
        repositories, please upgrade to a compatible paid plan.
      </p>
    </LimitReachedModal>
  );
}
