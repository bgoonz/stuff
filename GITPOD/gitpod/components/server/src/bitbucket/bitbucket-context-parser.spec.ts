...
import {
  BitbucketApiFactory,
  BasicAuthBitbucketApiFactory,
} from "./bitbucket-api-factory";
...
class TestBitbucketContextParser {
  ...
  public before() {
    ...
    container.load(
      new ContainerModule((bind, unbind, isBound, rebind) => {
        ...
        bind(AuthProviderParams).toConstantValue(
          TestBitbucketContextParser.AUTH_HOST_CONFIG
        );
        bind(BitbucketTokenHelper).toSelf().inSingletonScope();
        bind(TokenProvider).toConstantValue(<TokenProvider>{
          getTokenForHost: async () => DevData.createBitbucketTestToken(),
          getFreshPortAuthenticationToken: async (
            user: User,
            workspaceId: string
          ) => DevData.createPortAuthTestToken(workspaceId),
        });
        bind(BitbucketApiFactory)
          .to(BasicAuthBitbucketApiFactory)
          .inSingletonScope();
  ...
  @test public testCanHandleBitbucketRepo() {
    expect(
      this.parser.canHandle(
        this.user,
        "https://bitbucket.org/gitpod/sample-repository/src/master/"
      )
    ).to.be.true;
  }
  ...
  @test public testCanNotHandleGitHubRepo() {
    expect(
      this.parser.canHandle(this.user, "https://github.com/eclipse-theia/theia")
    ).to.be.false;
  }
  ...
  @test public async testShortContext_01() {
    const result = await this.parser.handle(
      {},
      this.user,
      "https://bitbucket.org/gitpod/sample-repository"
    );
  ...
  @test public async testSrcContext_02() {
    const result = await this.parser.handle(
      {},
      this.user,
      "https://bitbucket.org/gitpod/sample-repository/src/8fcf6c869d0cdb570bb6f2f9aa5f8ed72c9d953a/?at=Gitpod%2Ftesttxt-created-online-with-bitbucket-1589277871983"
    );
    expect(result).to.deep.include({
      ...
      title:
        "gitpod/sample-repository - Gitpod/testtxt-created-online-with-bitbucket-1589277871983",
    });
  }
  ...
  @test public async testSrcContext_03() {
    const result = await this.parser.handle(
      {},
      this.user,
      "https://bitbucket.org/gitpod/sample-repository/src/second-branch/"
    );
    expect(result).to.deep.include({
      ref: "second-branch",
      refType: "branch",
  ...
  @test public async testCommitsContext_01() {
    const result = await this.parser.handle(
      {},
      this.user,
      "https://bitbucket.org/gitpod/sample-repository/commits/branch/second-branch"
    );
    expect(result).to.deep.include({
      ref: "second-branch",
      refType: "branch",
  ...
  @test public async testBranchContext_01() {
    const result = await this.parser.handle(
      {},
      this.user,
      "https://bitbucket.org/gitpod/sample-repository/branch/master/"
    );
    expect(result).to.deep.include({
      ref: "master",
      refType: "branch",
  ...
  @test public async testBranchContext_02() {
    const result = await this.parser.handle(
      {},
      this.user,
      "https://bitbucket.org/gitpod/sample-repository/branch/second-branch"
    );
    expect(result).to.deep.include({
      ref: "second-branch",
      refType: "branch",
  ...
  @test public async testCommitsContext_02() {
    const result = await this.parser.handle(
      {},
      this.user,
      "https://bitbucket.org/gitpod/sample-repository/commits/tag/first-tag"
    );
    expect(result).to.deep.include({
      ref: "first-tag",
      refType: "tag",
  ...
  @test public async testSrcContext_04() {
    const result = await this.parser.handle(
      {},
      this.user,
      "https://bitbucket.org/gitpod/sample-repository/src/first-tag/"
    );
    expect(result).to.deep.include({
      ref: "first-tag",
      refType: "tag",
  ...
  @test public async testCommitsContext_03() {
    const result = await this.parser.handle(
      {},
      this.user,
      "https://bitbucket.org/gitpod/sample-repository/commits/5a24a0c8a7b42c2e6418593d788e17cb987bda25"
    );
    expect(result).to.deep.include({
      ref: "",
      refType: "revision",
      ...
      title:
        "gitpod/sample-repository - 5a24a0c8a7b42c2e6418593d788e17cb987bda25",
    });
  }
  ...
  @test public async testFileContext_01() {
    const result = await this.parser.handle(
      {},
      this.user,
      "https://bitbucket.org/gitpod/sample-repository/src/master/README.md"
    );
    expect(result).to.deep.include({
      ref: "master",
      refType: "branch",
  ...
  @test public async testFileContext_02() {
    const result = await this.parser.handle(
      {},
      this.user,
      "https://bitbucket.org/gitpod/sample-repository/src/branch-with-dir/my-dir/test.txt"
    );
    expect(result).to.deep.include({
      ref: "branch-with-dir",
      refType: "branch",
  ...
  @test public async testDirectoryContext_01() {
    const result = await this.parser.handle(
      {},
      this.user,
      "https://bitbucket.org/gitpod/sample-repository/src/branch-with-dir/my-dir/"
    );
    expect(result).to.deep.include({
      ref: "branch-with-dir",
      refType: "branch",
  ...
  @test public async testPullRequestContext_01() {
    const result = await this.parser.handle(
      {},
      this.user,
      "https://bitbucket.org/gitpod/sample-repository/pull-requests/1/readme-updated/diff"
    );
    expect(result).to.deep.include({
  ...
  @test public async testPullRequestContext_02() {
    const result = await this.parser.handle(
      {},
      this.user,
      "https://bitbucket.org/gitpod/sample-repository/pull-requests/3/say-hello-to-gitpod/diff"
    );
    expect(result).to.deep.include({
  ...
  @test public async testIssueContext_01() {
    const result = await this.parser.handle(
      {},
      this.user,
      "https://bitbucket.org/gitpod/sample-repository/issues/1/first-issue"
    );
    expect(result).to.deep.include({
      title: "First issue",
      repository: {
  ...
  @test public async testSrcContextForkedRepo_01() {
    const result = await this.parser.handle(
      {},
      this.user,
      "https://bitbucket.org/gitpod/clu-sample-repo/src/master/"
    );
    expect(result).to.deep.include({
      ref: "master",
      refType: "branch",
      ...
      repository: {
        ...
        fork: {
          parent: {
            cloneUrl:
              "https://bitbucket.org/corneliusludmann/my-sample-repo.git",
            defaultBranch: "master",
            host: "bitbucket.org",
            name: "my-sample-repo",
