...
} from "@gitpod/content-service/lib/content_pb";
...
export class ContentServiceStorageClient implements StorageClient {
  @inject(ContentServiceClient)
  private readonly contentServiceClient: ContentServiceClient;
  @inject(WorkspaceServiceClient)
  private readonly workspaceServiceClient: WorkspaceServiceClient;
  @inject(IDEPluginServiceClient)
  private readonly idePluginServiceClient: IDEPluginServiceClient;
  ...
  public async deleteUserContent(ownerId: string): Promise<void> {
    ...
    await new Promise<DeleteUserContentResponse>((resolve, reject) => {
      this.contentServiceClient.deleteUserContent(
        request,
        (err: any, resp: DeleteUserContentResponse) => {
          if (err) {
            reject(err);
          } else {
            resolve(resp);
  ...
  public async deleteWorkspaceBackups(
    ...
    await new Promise<DeleteWorkspaceResponse>((resolve, reject) => {
      this.workspaceServiceClient.deleteWorkspace(
        request,
        (err: any, resp: DeleteWorkspaceResponse) => {
          if (err) {
            reject(err);
          } else {
            resolve(resp);
  ...
  public async createWorkspaceContentDownloadUrl(
    ownerId: string,
    workspaceId: string
  ): Promise<string> {
    ...
    const response = await new Promise<WorkspaceDownloadURLResponse>(
      (resolve, reject) => {
        this.workspaceServiceClient.workspaceDownloadURL(
          request,
          (err: any, resp: WorkspaceDownloadURLResponse) => {
            if (err) {
              reject(err);
            } else {
              resolve(resp);
  ...
  public async createPluginUploadUrl(
    bucket: string,
    objectPath: string
  ): Promise<string> {
    ...
    const response = await new Promise<PluginUploadURLResponse>(
      (resolve, reject) => {
        this.idePluginServiceClient.uploadURL(
          request,
          (err: any, resp: PluginUploadURLResponse) => {
            if (err) {
              reject(err);
            } else {
              resolve(resp);
  ...
  public async createPluginDownloadUrl(
    bucket: string,
    objectPath: string
  ): Promise<string> {
    ...
    const response = await new Promise<PluginDownloadURLResponse>(
      (resolve, reject) => {
        this.idePluginServiceClient.downloadURL(
          request,
          (err: any, resp: PluginDownloadURLResponse) => {
            if (err) {
              reject(err);
            } else {
              resolve(resp);
  ...
  public async getPluginHash(
    ...
    const response = await new Promise<PluginHashResponse>(
      (resolve, reject) => {
        this.idePluginServiceClient.pluginHash(
          request,
          (err: any, resp: PluginHashResponse) => {
            if (err) {
              reject(err);
            } else {
              resolve(resp);
