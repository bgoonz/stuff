...
@injectable()
export class ClientDataPrometheusAdapterImpl
  implements IClientDataPrometheusAdapter
{
  ...
  storePrebuildQueueLength(
    ...
    this.prebuildQueueSizeGauge.set(
      { cloneURL, region: this.env.installationShortname },
      queueLength,
      time
    );
  }
