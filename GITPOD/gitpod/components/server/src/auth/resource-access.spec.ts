...
class TestResourceAccess {
  @test public async areScopesSubsetOf() {
    const tests: {
      ...
      {
        name: "empty upper, function lower",
        upper: [],
        lower: ["function:foo"],
        isSubset: false,
      },
      ...
      {
        name: "function upper, empty lower",
        upper: ["function:foo"],
        lower: [],
        isSubset: true,
      },
  ...
  @test public async tokenResourceGuardCanAccess() {
    ...
    const tests: {
      ...
      },
      {
        ...
        guard: new TokenResourceGuard("someoneElse", [
          TokenResourceGuard.DefaultResourceScope,
        ]),
        expectation: false,
      },
      {
        ...
        guard: new TokenResourceGuard(workspaceResource.subject.ownerId, [
          "resource:" +
            ScopedResourceGuard.marshalResourceScopeFromResource(
              workspaceResource,
              ["get"]
            ),
        ]),
    ...
    await Promise.all(
      tests.map(async (t) => {
        const res = await t.guard.canAccess(
          t.resource || workspaceResource,
          t.operation || "get"
        );
        expect(res).to.be.eq(
          t.expectation,
  ...
  @test public async workspaceEnvVarAccessGuardCanAccess() {
    const getEnvVarResourceScope: ScopedResourceGuard.ResourceScope<"envVar"> =
      { kind: "envVar", subjectID: "foo/x", operations: ["get"] };
    const tests: {
      name: string;
      guard: ScopedResourceGuard;
    ...
    }[] = [
      {
        ...
        guardEnvVar: {
          kind: "envVar",
          subject: { repositoryPattern: "*/*" } as UserEnvVar,
        },
        operation: "get",
        expectation: false,
      },
      ...
      },
      {
        ...
        guardEnvVar: {
          kind: "envVar",
          subject: { repositoryPattern: "*/x" } as UserEnvVar,
        },
        operation: "get",
        expectation: true,
      },
      {
        ...
        guardEnvVar: {
          kind: "envVar",
          subject: { repositoryPattern: "*/y" } as UserEnvVar,
        },
        operation: "get",
        expectation: false,
      },
      {
        ...
        guardEnvVar: {
          kind: "envVar",
          subject: { repositoryPattern: "foo/*" } as UserEnvVar,
        },
        operation: "get",
        expectation: true,
      },
      {
        ...
        guardEnvVar: {
          kind: "envVar",
          subject: { repositoryPattern: "bar/*" } as UserEnvVar,
        },
        operation: "get",
        expectation: false,
      },
      {
        ...
        guardEnvVar: {
          kind: "envVar",
          subject: { repositoryPattern: "foo/x" } as UserEnvVar,
        },
        operation: "get",
        expectation: true,
      },
      {
        ...
        guardEnvVar: {
          kind: "envVar",
          subject: { repositoryPattern: "foo/y" } as UserEnvVar,
        },
        operation: "get",
        expectation: false,
      },
      ...
      },
      {
        ...
        guardEnvVar: {
          kind: "envVar",
          subject: { repositoryPattern: "bar/x" } as UserEnvVar,
        },
        operation: "get",
        expectation: false,
      },
      {
        ...
        guardEnvVar: {
          kind: "envVar",
          subject: { repositoryPattern: "bar/y" } as UserEnvVar,
        },
        operation: "get",
        expectation: false,
      },
