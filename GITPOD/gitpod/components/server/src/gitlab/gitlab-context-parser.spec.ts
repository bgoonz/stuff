...
@suite(
  timeout(10000),
  retries(2),
  skipIfEnvVarNotSet("GITPOD_TEST_TOKEN_GITLAB")
)
class TestGitlabContextParser {
    ...
    container.load(
      new ContainerModule((bind, unbind, isBound, rebind) => {
        ...
        bind(AuthProviderParams).toConstantValue(
          TestGitlabContextParser.AUTH_HOST_CONFIG
        );
  ...
  @test public async testTreeContext_04() {
    const result = await this.parser.handle(
      {},
      this.user,
      "https://gitlab.com/AlexTugarev/gp-test/tree/master"
    );
    expect(result).to.deep.include({
      ref: "master",
      refType: "branch",
  ...
  @test public async testTreeContext_tag_01() {
    const result = await this.parser.handle(
      {},
      this.user,
      "https://gitlab.com/AlexTugarev/gp-test/tree/test-tag"
    );
    expect(result).to.deep.include({
      ref: "test-tag",
      refType: "tag",
  ...
  @test public async testCommitsContext_01() {
    const result = await this.parser.handle(
      {},
      this.user,
      "https://gitlab.com/AlexTugarev/gp-test/-/commits/wip"
    );
    expect(result).to.deep.include({
      ref: "wip",
      refType: "branch",
  ...
  @test public async testTreeContextSubgroup_01() {
    ...
    expect(result).to.deep.include({
      ...
      repository: {
        ...
        cloneUrl:
          "https://gitlab.com/gp-test-group/gp-test-subgroup/gp-test-project-in-subgroup.git",
        defaultBranch: "master",
        private: false,
      },
      title:
        "gp-test-group/gp-test-subgroup/gp-test-project-in-subgroup - master",
    });
  }
  ...
  @test public async testTreeContextSubgroup_02() {
    ...
    expect(result).to.deep.include({
      ...
      title:
        "gp-test-group/gp-test-subgroup/gp-test-project-in-subgroup - branchtwo",
    });
  }
  ...
  @test public async testTreeContextSubgroup_tag_01() {
    ...
    expect(result).to.deep.include({
      ...
      title:
        "gp-test-group/gp-test-subgroup/gp-test-project-in-subgroup - test-tag",
    });
  }
  ...
  @test public async testTreeContextBranchWithSlash() {
    ...
    expect(result).to.deep.include({
      ...
      title:
        "gp-test-group/gp-test-subgroup/gp-test-project-in-subgroup - corneliusludmann/important-issue-1",
    });
  }
  ...
  @test public async testTreeContextTagWithSlash() {
    ...
    expect(result).to.deep.include({
      ...
      title:
        "gp-test-group/gp-test-subgroup/gp-test-project-in-subgroup - tag/withslash",
    });
  }
