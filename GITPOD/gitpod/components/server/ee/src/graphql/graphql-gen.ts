...
export type ResolversTypes = ResolversObject<{
  ...
  Node:
    ...
    | ResolversTypes["WorkspaceInstance"];
  ...
  ORDER_DIR: Order_Dir;
  UserPaginationResult: ResolverTypeWrapper<
    Omit<UserPaginationResult, "items"> & {
      items: Array<ResolversTypes["User"]>;
    }
  >;
  WORKSPACE_ORDER_KEYS: Workspace_Order_Keys;
  WorkspacePaginationResult: ResolverTypeWrapper<
    Omit<WorkspacePaginationResult, "items"> & {
      items: Array<ResolversTypes["Workspace"]>;
    }
  >;
  WORKSPACE_INSTANCE_ORDER_KEYS: Workspace_Instance_Order_Keys;
  WorkspaceInstancePaginationResult: ResolverTypeWrapper<
    Omit<WorkspaceInstancePaginationResult, "items"> & {
      items: Array<ResolversTypes["WorkspaceInstance"]>;
    }
  >;
}>;
...
export type ResolversParentTypes = ResolversObject<{
  ...
  Node:
    ...
    | ResolversParentTypes["Workspace"]
    | ResolversParentTypes["WorkspaceInstance"];
  ID: Scalars["ID"];
  ...
  USER_ORDER_KEYS: User_Order_Keys;
  ORDER_DIR: Order_Dir;
  UserPaginationResult: Omit<UserPaginationResult, "items"> & {
    items: Array<ResolversParentTypes["User"]>;
  };
  WORKSPACE_ORDER_KEYS: Workspace_Order_Keys;
  WorkspacePaginationResult: Omit<WorkspacePaginationResult, "items"> & {
    items: Array<ResolversParentTypes["Workspace"]>;
  };
  WORKSPACE_INSTANCE_ORDER_KEYS: Workspace_Instance_Order_Keys;
  WorkspaceInstancePaginationResult: Omit<
    WorkspaceInstancePaginationResult,
    "items"
  > & { items: Array<ResolversParentTypes["WorkspaceInstance"]> };
}>;
...
> = ResolversObject<{
  __resolveType: TypeResolveFn<
    "User" | "Workspace" | "WorkspaceInstance",
    ParentType,
    ContextType
  >;
...
> = ResolversObject<{
  ...
  >;
  users?: Resolver<
    Maybe<ResolversTypes["UserPaginationResult"]>,
    ParentType,
    ContextType,
    RequireFields<QueryUsersArgs, "offset" | "limit" | "orderBy" | "orderDir">
  >;
  userCount?: Resolver<ResolversTypes["Int"], ParentType, ContextType>;
  workspaces?: Resolver<
    Maybe<ResolversTypes["WorkspacePaginationResult"]>,
    ParentType,
    ContextType,
    RequireFields<
      QueryWorkspacesArgs,
    ...
    >
  >;
  workspaceInstances?: Resolver<
    Maybe<ResolversTypes["WorkspaceInstancePaginationResult"]>,
    ParentType,
    ContextType,
    RequireFields<
      QueryWorkspaceInstancesArgs,
      "offset" | "limit" | "orderBy" | "orderDir" | "onlyRunning"
    >
  >;
}>;
...
> = ResolversObject<{
  ...
  instances?: Resolver<
    Array<ResolversTypes["WorkspaceInstance"]>,
    ParentType,
    ContextType
  >;
  __isTypeOf?: isTypeOfResolverFn<ParentType>;
...
export type WorkspaceInstanceResolvers<
  ContextType = Context,
  ParentType extends ResolversParentTypes["WorkspaceInstance"] = ResolversParentTypes["WorkspaceInstance"]
> = ResolversObject<{
  id?: Resolver<ResolversTypes["ID"], ParentType, ContextType>;
  workspace?: Resolver<
  ...
  >;
  creationTime?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
  deployedTime?: Resolver<
    Maybe<ResolversTypes["String"]>,
    ParentType,
    ContextType
  >;
  startedTime?: Resolver<
    Maybe<ResolversTypes["String"]>,
    ParentType,
    ContextType
  >;
  stoppedTime?: Resolver<
    Maybe<ResolversTypes["String"]>,
    ParentType,
    ContextType
  >;
  ...
  status?: Resolver<
    ResolversTypes["WorkspaceInstanceStatus"],
    ParentType,
    ContextType
  >;
  deleted?: Resolver<Maybe<ResolversTypes["Boolean"]>, ParentType, ContextType>;
...
export type WorkspaceInstanceConditionsResolvers<
  ContextType = Context,
  ParentType extends ResolversParentTypes["WorkspaceInstanceConditions"] = ResolversParentTypes["WorkspaceInstanceConditions"]
> = ResolversObject<{
  ...
  pullingImages?: Resolver<
    Maybe<ResolversTypes["Boolean"]>,
    ParentType,
    ContextType
  >;
  serviceExists?: Resolver<
    Maybe<ResolversTypes["Boolean"]>,
    ParentType,
    ContextType
  >;
  deployed?: Resolver<
    ...
    ContextType
  >;
  neededImageBuild?: Resolver<
    Maybe<ResolversTypes["Boolean"]>,
    ParentType,
    ContextType
  >;
  firstUserActivity?: Resolver<
    Maybe<ResolversTypes["String"]>,
    ParentType,
    ContextType
  >;
...
export type WorkspaceInstancePaginationResultResolvers<
  ContextType = Context,
  ParentType extends ResolversParentTypes["WorkspaceInstancePaginationResult"] = ResolversParentTypes["WorkspaceInstancePaginationResult"]
> = ResolversObject<{
  total?: Resolver<ResolversTypes["Int"], ParentType, ContextType>;
  hasMore?: Resolver<ResolversTypes["Boolean"], ParentType, ContextType>;
  items?: Resolver<
...
export type WorkspaceInstanceStatusResolvers<
  ContextType = Context,
  ParentType extends ResolversParentTypes["WorkspaceInstanceStatus"] = ResolversParentTypes["WorkspaceInstanceStatus"]
> = ResolversObject<{
  phase?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
  conditions?: Resolver<
    ResolversTypes["WorkspaceInstanceConditions"],
    ParentType,
    ContextType
  >;
  __isTypeOf?: isTypeOfResolverFn<ParentType>;
...
export type WorkspacePaginationResultResolvers<
  ContextType = Context,
  ParentType extends ResolversParentTypes["WorkspacePaginationResult"] = ResolversParentTypes["WorkspacePaginationResult"]
> = ResolversObject<{
  total?: Resolver<ResolversTypes["Int"], ParentType, ContextType>;
  hasMore?: Resolver<ResolversTypes["Boolean"], ParentType, ContextType>;
