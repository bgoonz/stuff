...
export class EMailDomainServiceImpl implements EMailDomainService {
  ...
  protected readonly domainFilterDb: EmailDomainFilterDB;
  ...
  protected async checkDBForEducationalInstitutionSuffix(
    domain: string
  ): Promise<boolean> {
  ...
  protected async checkSwotJsForEducationalInstitutionSuffix(
    email: string
  ): Promise<boolean> {
