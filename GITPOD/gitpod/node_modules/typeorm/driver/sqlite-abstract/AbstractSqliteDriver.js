...
var AbstractSqliteDriver = /** @class */ (function () {
    ...
    AbstractSqliteDriver.prototype.preparePersistentValue = function (value, columnMetadata) {
        ...
        if (columnMetadata.type === Boolean || columnMetadata.type === "boolean") {
            ...
            return DateUtils_1.DateUtils.mixedDateToDatetimeString(value); // to string conversation needs because SQLite stores fate as integer number, when date came as Object
        }
