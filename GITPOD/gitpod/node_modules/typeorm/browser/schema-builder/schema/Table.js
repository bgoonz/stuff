...
var Table = /** @class */ (function () {
    ...
    Table.prototype.findChangedColumns = function (driver, columnMetadatas) {
        ...
        return this.columns.filter(function (tableColumn) {
            ...
            var skipGenerationCheck = columnMetadata.generationStrategy === "uuid" && (driver instanceof AbstractSqliteDriver || driver instanceof MysqlDriver || driver instanceof OracleDriver);
