...
var OAuthException = /*#__PURE__*/function (_Error) {
  ...
  OAuthException.invalidRequest = function invalidRequest(parameter, errorDescription) {
    ...
    return new OAuthException(message, exports.ErrorType.InvalidRequest, errorDescription);
  };

  OAuthException.invalidClient = function invalidClient(errorDescription) {
    return new OAuthException("Client authentication failed", exports.ErrorType.InvalidClient, errorDescription, undefined, HttpStatus.UNAUTHORIZED);
  };
  ...
  OAuthException.invalidGrant = function invalidGrant(errorDescription) {
    ...
    return new OAuthException(message, exports.ErrorType.InvalidGrant, errorDescription);
  };
  ...
  OAuthException.invalidScope = function invalidScope(scope, redirectUri) {
    ...
    return new OAuthException(message, exports.ErrorType.InvalidScope, hint, redirectUri);
  };

  OAuthException.unauthorizedClient = function unauthorizedClient() {
    return new OAuthException("unauthorized client", exports.ErrorType.UnauthorizedClient);
  };

  OAuthException.unsupportedGrantType = function unsupportedGrantType() {
    return new OAuthException("unsupported grant_type", exports.ErrorType.UnsupportedGrantType);
  };

  OAuthException.logicException = function logicException(message) {
    return new OAuthException(message, exports.ErrorType.InvalidRequest);
  };

  OAuthException.accessDenied = function accessDenied(errorDescription) {
    return new OAuthException("The resource owner or authorization server denied the request", exports.ErrorType.AccessDenied, errorDescription, undefined, HttpStatus.UNAUTHORIZED);
  };
...
var AbstractAuthorizedGrant = /*#__PURE__*/function (_AbstractGrant) {
  ...
  _proto.validateRedirectUri = function validateRedirectUri(redirectUri, client) {
    ...
    var parsed = uriJs.parse(redirectUri);
...
exports.AbstractAuthorizedGrant = AbstractAuthorizedGrant;
...
exports.BearerTokenResponse = BearerTokenResponse;
...
exports.PlainVerifier = PlainVerifier;
exports.REGEXP_CODE_CHALLENGE = REGEXP_CODE_CHALLENGE;
exports.REGEXP_CODE_VERIFIER = REGEXP_CODE_VERIFIER;
exports.REGEX_ACCESS_TOKEN = REGEX_ACCESS_TOKEN;
exports.RedirectResponse = RedirectResponse;
exports.RefreshTokenGrant = RefreshTokenGrant;
exports.S256Verifier = S256Verifier;
exports.arrayDiff = arrayDiff;
exports.base64decode = base64decode;
exports.base64encode = base64encode;
exports.base64urlencode = base64urlencode;
exports.getSecondsUntil = getSecondsUntil;
exports.isClientConfidential = isClientConfidential;
exports.roundToSeconds = roundToSeconds;
//# sourceMappingURL=oauth2-server.cjs.development.js.map
