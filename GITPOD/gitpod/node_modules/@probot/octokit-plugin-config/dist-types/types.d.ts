export declare type Configuration = Record<string, unknown>;
export declare type API = {
    config: {
        get<T extends Configuration = Configuration>(options: GetOptions<T>): Promise<GetResult<T>>;
    };
};
...
export declare type defaultsFunction<T> = (files: Configuration[]) => T;
