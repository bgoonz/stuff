...
const $bdceb2956edbee43435a9382ef97283f$var$focusScopeDataAttrNames = ['data-focus-scope-start', 'data-focus-scope-end'];

function $bdceb2956edbee43435a9382ef97283f$var$isFocusScopeDirectChild(scope) {
  return $bdceb2956edbee43435a9382ef97283f$var$focusScopeDataAttrNames.some(name => scope.getAttribute(name) !== null);
}

function $bdceb2956edbee43435a9382ef97283f$var$isFocusScopeNestedChild(scope) {
  return $bdceb2956edbee43435a9382ef97283f$var$focusScopeDataAttrNames.some(name => scope.querySelector("[" + name + "]"));
}

function $bdceb2956edbee43435a9382ef97283f$var$isFocusScopeInScope(scopes) {
  return scopes.some(scope => $bdceb2956edbee43435a9382ef97283f$var$isFocusScopeDirectChild(scope) || $bdceb2956edbee43435a9382ef97283f$var$isFocusScopeNestedChild(scope));
}

function $bdceb2956edbee43435a9382ef97283f$var$isElementInScope(element, scope) {
  return !$bdceb2956edbee43435a9382ef97283f$var$isFocusScopeInScope(scope) && scope.some(node => node.contains(element));
}
    ...
    let onKeyDown = e => {
      ...
      if ((!nextElement || !$bdceb2956edbee43435a9382ef97283f$var$isElementInScope(nextElement, scope)) && nodeToRestore) {
        ...
        if (nextElement) {
          ...
          if (!$bdceb2956edbee43435a9382ef97283f$var$isElementInAnyScope(nodeToRestore, $bdceb2956edbee43435a9382ef97283f$var$scopes)) {
            focusedElement.blur();
          } else {
