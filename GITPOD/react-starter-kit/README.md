...
- Run in browser: [Open this project](https://gitpod.io/#https://github.com/gitpod-io/react-starter-kit) in an online dev environment (Gitpod.io)
- Local setup: Follow the [getting started guide](./docs/getting-started.md) to download and run the project
