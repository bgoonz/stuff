...
def_test("filtered_result_count_test1", function () {
  ...
  if (
    el.textContent.match(
      /Showing \d+ to \d+ of 29 entries.*from 117 total entries/
    )
  ) {
    ret = true;
  } else {
...
def_test("filtered_result_count_test2", function () {
  ...
  if (
    el.textContent.match(
      /Showing \d+ to \d+ of 4 entries.*from 117 total entries/
    )
  ) {
    ret = true;
  } else {
...
def_test("filtered_result_count_test3", function () {
  ...
  if (
    el.textContent.match(
      /Showing \d+ to \d+ of 0 entries.*from 117 total entries/
    )
  ) {
    ret = true;
  } else {
...
def_test("filtered_result_count_test5", function () {
  ...
  if (
    el.textContent.match(
      /Showing \d+ to \d+ of 68 entries.*from 117 total entries/
    )
  ) {
    ret = true;
  } else {
...
def_test("filtered_result_count_test5", function () {
  ...
  if (
    el.textContent.match(
      /Showing \d+ to \d+ of 45 entries.*from 117 total entries/
    )
  ) {
    ret = true;
  } else {
