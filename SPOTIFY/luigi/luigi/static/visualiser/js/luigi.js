var LuigiAPI = (function () {
  ...
  LuigiAPI.prototype.getDependencyGraph = function (
    taskId,
    callback,
    include_done
  ) {
    return jsonRPC(
      this.urlRoot + "/dep_graph",
      { task_id: taskId, include_done: include_done },
      function (response) {
  ...
  LuigiAPI.prototype.getInverseDependencyGraph = function (
    taskId,
    callback,
    include_done
  ) {
    return jsonRPC(
      this.urlRoot + "/inverse_dep_graph",
      { task_id: taskId, include_done: include_done },
      function (response) {
        callback(flatten(response.response, taskId));
      }
  ...
  LuigiAPI.prototype.getFailedTaskList = function (callback) {
    return jsonRPC(
      this.urlRoot + "/task_list",
      { status: "FAILED", upstream_status: "", search: searchTerm() },
      function (response) {
        callback(flatten(response.response));
      }
    );
  ...
  LuigiAPI.prototype.getUpstreamFailedTaskList = function (callback) {
    return jsonRPC(
      ...
      {
        status: "PENDING",
        upstream_status: "UPSTREAM_FAILED",
        search: searchTerm(),
      },
      function (response) {
        callback(flatten(response.response));
  ...
  LuigiAPI.prototype.getDoneTaskList = function (callback) {
    return jsonRPC(
      this.urlRoot + "/task_list",
      { status: "DONE", upstream_status: "", search: searchTerm() },
      function (response) {
        callback(flatten(response.response));
      }
    );
  ...
  LuigiAPI.prototype.getTaskStatusMessage = function (taskId, callback) {
    return jsonRPC(
      this.urlRoot + "/get_task_status_message",
      { task_id: taskId },
      function (response) {
        callback(response.response);
      }
  ...
  LuigiAPI.prototype.getTaskProgressPercentage = function (taskId, callback) {
    return jsonRPC(
      this.urlRoot + "/get_task_progress_percentage",
      { task_id: taskId },
      function (response) {
        callback(response.response);
      }
  ...
  LuigiAPI.prototype.getRunningTaskList = function (callback) {
    return jsonRPC(
      this.urlRoot + "/task_list",
      { status: "RUNNING", upstream_status: "", search: searchTerm() },
      function (response) {
        callback(flatten(response.response));
      }
    );
  ...
  LuigiAPI.prototype.getBatchRunningTaskList = function (callback) {
    return jsonRPC(
      this.urlRoot + "/task_list",
      { status: "BATCH_RUNNING", upstream_status: "", search: searchTerm() },
      function (response) {
        callback(flatten(response.response));
      }
    );
  ...
  LuigiAPI.prototype.getPendingTaskList = function (callback) {
    return jsonRPC(
      this.urlRoot + "/task_list",
      { status: "PENDING", upstream_status: "", search: searchTerm() },
      function (response) {
        callback(flatten(response.response));
      }
    );
  ...
  LuigiAPI.prototype.getDisabledTaskList = function (callback) {
    jsonRPC(
      this.urlRoot + "/task_list",
      { status: "DISABLED", upstream_status: "", search: searchTerm() },
      function (response) {
        callback(flatten(response.response));
      }
    );
  ...
  LuigiAPI.prototype.getUpstreamDisabledTaskList = function (callback) {
    jsonRPC(
      ...
      {
        status: "PENDING",
        upstream_status: "UPSTREAM_DISABLED",
        search: searchTerm(),
      },
      function (response) {
        callback(flatten(response.response));
  ...
  LuigiAPI.prototype.sendSchedulerMessage = function (
    workerId,
    taskId,
    content,
    callback
    ...
    jsonRPC(
      this.urlRoot + "/send_scheduler_message",
      data,
      function (response) {
        if (callback) {
  ...
  LuigiAPI.prototype.getSchedulerMessageResponse = function (
    taskId,
    messageId,
    callback
  ) {
    ...
    jsonRPC(
      this.urlRoot + "/get_scheduler_message_response",
      data,
      function (response) {
