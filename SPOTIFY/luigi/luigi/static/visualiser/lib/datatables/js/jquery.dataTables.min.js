...
(function (Ea, P, k) {
  var O = function (h) {
            ...
            (g = n[i]),
              ...
              g && g._bAttrSrc
                ? (Q(g.mData._)(e, j),
                  ...
                  q(g.mData.filter, a))
                : l
                ? (g._setter || (g._setter = Q(g.mData)), g._setter(e, j))
                : (e[i] = j);
          i++;
        };
      if (f)
    ...
    function Ja(a, b, c, e) {
      ...
      if (null === d.nTr) {
        ...
        for (q = a.aoColumns.length; l < q; l++) {
          ...
          h.fnCreatedCell &&
            h.fnCreatedCell.call(a.oInstance, j, y(a, b, l), f, b, l);
        }
        ...
        if (0 !== j.length) {
          ...
          for (i = i ? 0 : g; i < f; i++) {
            ...
            if (0 !== d) {
              var o = e[c % d];
              q._sRowStripe != o &&
                (h(l).removeClass(q._sRowStripe).addClass(o),
                (q._sRowStripe = o));
            }
    ...
    function mb(a) {
      ...
      for (
        var f = a.sDom.split(""), g, i, j, n, l, q, o = 0;
        o < f.length;
        o++
      ) {
        g = null;
        ...
        g &&
          ((j = a.aanFeatures), j[i] || (j[i] = []), j[i].push(g), d.append(g));
      }
      c.replaceWith(d);
    }
    function da(a, b) {
    ...
    function tb(a) {
      ...
      for (g = 0; g < c; g++)
        (n = b[g]),
          ...
          o("mDataProp_" + g, j),
          e.bFilter &&
            (o("sSearch_" + g, l.sSearch),
            o("bRegex_" + g, l.bRegex),
            o("bSearchable_" + g, n.bSearchable)),
          e.bSort && o("bSortable_" + g, n.bSortable);
    ...
    function Y(a) {
      ...
      b.bCollapse &&
        "" !== d &&
        (o.height = q[0].offsetHeight + m[0].offsetHeight + "px");
      g = r.outerWidth();
      if ("" === c) {
        if (
          ((u.width = "100%"),
          w &&
            (r.find("tbody").height() > j.offsetHeight ||
      ...
      if (r.outerWidth() < g) {
        v =
          j.scrollHeight > j.offsetHeight || "scroll" == q.css("overflow-y")
            ? g + f
            : g;
        if (
          w &&
      ...
      d &&
        ...
        t.offsetHeight < j.offsetHeight && (o.height = s(t.offsetHeight + b)));
      b = r.outerWidth();
      l[0].style.width = s(b);
      n.width = s(b);
    ...
    function Ga(a) {
      ...
      if (!k && !f && !d && i == aa(a) && i == j.length)
        ...
        f && g
          ...
          : f
          ? (i.css("width", "auto"),
            i.width() < l.offsetWidth && i.width(l.offsetWidth))
          : d
          ...
          for (o = g = 0; o < e.length; o++)
            (m = c[e[o]]),
              ...
              (g +=
                null === m.sWidthOrig
                  ? d
                  : parseInt(m.sWidth, 10) + d - h(j[o]).width());
          i.width(s(g));
          b.style.width = s(g);
        }
        for (o = 0; o < e.length; o++)
          if (((m = c[e[o]]), (d = h(j[o]).width()))) m.sWidth = s(d);
    ...
    function T(a) {
      ...
      for (a = 0; a < n.length; a++) {
        ...
        for (c = f.length; b < c; b++)
          (g = f[b]),
            (i = d[g].sType || "string"),
            n[a]._idx === k && (n[a]._idx = h.inArray(n[a][1], d[g].asSorting)),
            e.push({
              src: j,
              col: g,
              dir: n[a][1],
    ...
    m = function (a) {
      ...
      this.each(function () {
        ...
        if ("table" != this.nodeName.toLowerCase())
          ...
          j = p.oClasses;
          d.bJQueryUI
            ? (h.extend(j, m.ext.oJUIClasses, d.oClasses),
              d.sDom === l.sDom &&
                "lfrtip" === l.sDom &&
                (p.sDom = '<"H"lfr>t<"F"ip>'),
              p.renderer)
              ...
              : (p.renderer = "jqueryui")
            : h.extend(j, m.ext.classes, d.oClasses);
          q.addClass(j.sTable);
          ...
          null === d.asStripeClasses &&
            (p.asStripeClasses = [j.sStripeOdd, j.sStripeEven]);
          ...
          0 === i.length || 0 === i.children().length
            ? q.addClass(j.sNoFooter)
            : 0 < i.length && ((p.nTFoot = i[0]), da(p.aoFooter, p.nTFoot));
          if (d.aaData) for (g = 0; g < d.aaData.length; g++) J(p, d.aaData[g]);
          else
          ...
          if ("table" === b) (f = c.call(p, l[g], g)), f !== k && d.push(f);
            ...
            for (n = o.length; j < n; j++)
              (f = o[j]),
                (f =
                  "cell" === b
                    ? c.call(p, l[g], f.row, f.column, g, j)
                    : c.call(p, l[g], f, g, j, q)),
                f !== k && d.push(f);
          }
        }
        return d.length || e
    ...
    t.register = r = function (a, b) {
      if (h.isArray(a))
        ...
        for (
          var d = a.split("."), f = Tb, g, i, c = 0, e = d.length;
          c < e;
          c++
        ) {
    ...
    var $a = function (a, b) {
        ...
        for (g = a.length; f < g; f++) {
          ...
          for (j = d.length; i < j; i++)
            (e = b("string" === typeof d[i] ? h.trim(d[i]) : d[i])) &&
              e.length &&
              c.push.apply(c, e);
        }
        return c;
