...
lingon.preProcessors.push("alternativesyntax", function (params) {
  return [createProcessor("alternative pre")];
});

lingon.preProcessors.push("multiplesyntax", function (params) {
  return [createProcessor("multiple1 pre"), createProcessor("multiple2 pre")];
});
...
var simplesyntaxPostFunction = function (params) {
  return createProcessor(
    "simple path-matching and to be removed by simplesyntaxPostFunction post"
  );
};
lingon.postProcessors.push(
  ["simplesyntax", "simplealias"],
  /matching-again/,
  simplesyntaxPostFunction
);
...
lingon.postProcessors.push(["alternativesyntax"], function (params) {
  return [createProcessor("alternative post")];
});
...
lingon.postProcessors.push(["multiplesyntax"], function (params) {
  return [createProcessor("multiple2 post"), createProcessor("multiple3 post")];
});
...
lingon.postProcessors.push(["orderedsyntax"], function (params) {
  return [createProcessor("ordered3 post"), createProcessor("ordered4 post")];
});
