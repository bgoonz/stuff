  ...
  describe("#log", function () {
    it("It should not log since it is not enabled", function () {
      var result = logger.log(
        "RADIO",
        ["Performance for serializing is", 15, 35],
        "performance"
      );
    ...
    it("Should log stuff with the RADIO, CONTACT module and performance, data tag", function () {
      ...
      var result2 = logger.log(
        "RADIO",
        ["Performance for serializing is", 15, 35],
        "data"
      );
      var result3 = logger.log(
        "RADIO",
        ["Performance for serializing is", 15, 35],
        "temp"
      );
      var result4 = logger.log(
        "CONTACT",
        ["Username", "thodoris"],
        "performance"
      );
