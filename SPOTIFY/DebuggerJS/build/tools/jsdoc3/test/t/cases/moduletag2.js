(function () {
  ...
  test("When a @module tag defines a module module.", function () {
    ...
    assert.equal(
      mixer.kind,
      "module",
      'A symbol of kind "module" is documented.'
    );
  });
  ...
  test("When an object literal is lent to a module with a  @lends tag.", function () {
    ...
    assert.equal(
      blend.kind,
      "function",
      "A member of that object literal is documented as a member of the module."
    );
  });
  ...
  test('When a documented symbol is a member of a namespace "exports".', function () {
    ...
    assert.equal(
      darken.kind,
      "function",
      "It is documented as a member of the module."
    );
  });
})();
