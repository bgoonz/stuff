(function () {
  ...
  helper.registerLink(
    'test."long blah"/blah',
    "path/to/test_long_blah_blah.html"
  );
  ...
  test('ResolveLinks should translate {@link test."long blah"/blah} into a HTML link.', function () {
    ...
    assert.equal(
      output,
      'This is a <a href="path/to/test_long_blah_blah.html">test."long blah"/blah</a>.'
    );
  });
  ...
  test("ResolveLinks should translate [hello there]{@link test} into a HTML link with the custom content.", function () {
    ...
    assert.equal(
      output,
      'This is a <a href="path/to/test.html">hello there</a>.'
    );
  });
