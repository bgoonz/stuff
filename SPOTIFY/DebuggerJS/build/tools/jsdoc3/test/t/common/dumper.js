...
test("There is a common/dumper module.", function () {
  assert.equal(
    typeof common.dumper,
    "object",
    "The common/dumper module should be an object."
  );
});

test('The common/dumper module exports a "dump" function.', function () {
  assert.equal(
    typeof common.dumper.dump,
    "function",
    "The module:module:common/dumper.dump member should be a function."
  );
});
...
test("The module:module:common/dumper.dump function dumps string values.", function () {
  ...
  assert.equal(
    common.dumper.dump('hello "world"'),
    '"hello \\"world\\""',
    "Double quotes should be escaped."
  );
  assert.equal(
    common.dumper.dump("hello\nworld"),
    '"hello\\nworld"',
...
test("The module:module:common/dumper.dump function dumps number values.", function () {
  ...
  assert.equal(
    common.dumper.dump(0.1),
    "0.1",
    "Decimal numbers shuld be dumped."
  );
});
...
test("The module:module:common/dumper.dump function dumps date values.", function () {
  assert.equal(
    common.dumper.dump(new Date("January 1, 1901 GMT")),
    "<Date Tue, 01 Jan 1901 00:00:00 GMT>"
  );
});

test("The module:module:common/dumper.dump function dumps function values.", function () {
  assert.equal(
    common.dumper.dump(function myFunc() {}),
    "<Function myFunc>"
  );
  assert.equal(
    common.dumper.dump(function () {}),
    "<Function>"
  );
});
...
test("The module:common/dumper.dump function dumps constructed instance values.", function () {
  ...
  assert.equal(
    actual,
    expected,
    "Members of the instance should appear, but not prototype members."
  );
});
