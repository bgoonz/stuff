...
exports.jsdocSchema = {
  properties: {
    doc: {
      ...
      items: {
        ...
        properties: {
          ...
          path: {
            // unique identifier for each doc
            type: "string",
            maxItems: 1,
          },
          description: {
          ...
          scope: {
            // how is this symbol attached to it's enclosing scope?
            type: "string",
            maxItems: 1,
          ...
          refersto: {
            // the path to another doc: this doc is simply a renamed alias to that
            type: "string",
            optional: true,
            maxItems: 1,
          },
          access: {
            // what access priviledges are allowed
            type: "string",
            optional: true,
            maxItems: 1,
          ...
          attrib: {
            // other attributes, like "readonly"
            type: "string",
            optional: true,
          },
          type: {
          ...
          exception: {
            ...
            properties: {
              type: {
                // what is the type of the value thrown?
                type: "array",
                optional: true,
                items: {
                  type: "string",
              ...
              description: {
                // a description of the thrown value
                type: "string",
                optional: true,
              },
            },
          ...
          returns: {
            ...
            properties: {
              type: {
                // what is the type of the value returned?
                type: ["string", "array"],
                optional: true,
                items: {
                  type: "string",
          ...
          meta: {
            ...
            properties: {
              file: {
                // what is the name of the file this doc appears in?
                type: "string",
                optional: true,
                maxItems: 1,
              },
              line: {
                // on what line of the file does this doc appear?
                type: "number",
                optional: true,
                maxItems: 1,
              },
    ...
    meta: {
      // information about the generation for all the docs
      type: "object",
      optional: true,
      maxItems: 1,
      properties: {
        project: {
          // to what project does this doc belong?
          type: "object",
          optional: true,
          maxItems: 1,
          properties: {
        ...
        generated: {
          // some information about the running of the doc generator
          type: "object",
          optional: true,
          maxItems: 1,
          properties: {
            date: {
              // on what date and time was the doc generated?
              type: "string",
              maxItems: 1,
              optional: true,
              format: "date-time",
            ...
            parser: {
              // what tool was used to generate the doc?
              type: "string",
              maxItems: 1,
              optional: true,
            },
