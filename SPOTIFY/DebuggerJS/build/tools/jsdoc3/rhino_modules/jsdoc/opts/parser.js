...
argParser.addOption(
  ...
  "template",
  true,
  'The name of the template to use. Default: the "default" template'
);
argParser.addOption(
  "c",
  "configure",
...
argParser.addOption(
  ...
  "encoding",
  true,
  "Assume this encoding when reading all source files. Default: utf-8"
);
...
argParser.addOption(
  ...
  "destination",
  true,
  'The path to the output folder. Use "console" to dump data to the console. Default: console'
);
argParser.addOption(
  "p",
  "private",
  false,
  "Display symbols marked with the @private tag. Default: false."
);
argParser.addOption(
  "r",
  "recurse",
  false,
  "Recurse into subdirectories when scanning for source code files."
);
...
argParser.addOption(
  ...
  "query",
  true,
  "Provide a querystring to define custom variable names/values to add to the options hash."
);
argParser.addOption(
  "u",
  "tutorials",
