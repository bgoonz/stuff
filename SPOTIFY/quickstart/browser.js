  ...
  return quickstart
    ...
    .then(function (id) {
      ...
      if (config.sourceMap) {
        ...
        var source =
          output.code + sourceMappingURL + btoa(JSON.stringify(output.map));
        ...
        var runtimeFn = new Function(
          "main",
          "modules",
          runtimeData + sourceURL + runtimePath.substr(2)
        );
