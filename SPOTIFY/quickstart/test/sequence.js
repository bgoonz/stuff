...
describe("sequence", function () {
  describe("find", function () {
    it("should fulfill", function () {
      return expect(
        sequence.find([1, 2, 3, 4], function (value) {
  ...
  describe("filter", function () {
    it("should fulfill", function () {
      return expect(
        sequence.filter([1, 2, 3, 4], function (value) {
  ...
  describe("map", function () {
    it("should fulfill", function () {
      return expect(
        sequence.map([1, 2, 3, 4], function (value) {
          return resolve(value * 2);
        })
  ...
  describe("all", function () {
    it("should fulfill", function () {
      return expect(
        sequence.all([1, 2, 3, 4], function (value) {
          return resolve(value * 2);
        })
      ).to.eventually.eql([2, 4, 6, 8]);
    });
  ...
  describe("every", function () {
    it("should fulfill", function () {
      return expect(
        sequence.every([1, 2, 3, 4], function (value) {
          return resolve(value * 2);
        })
      ).to.eventually.eql([2, 4, 6, 8]);
    });
  ...
  describe("race", function () {
    it("should fulfill", function () {
      return expect(
        sequence.race([40, 20, 60], function (time) {
