(function (e) {
      ...
      e.each(t.getAxes(), function (e, t) {
        ...
        if (i.mode == "time") {
          t.tickGenerator = function (e) {
            ...
            var u = 0;
            var l =
              (i.tickSize && i.tickSize[1] === "quarter") ||
              (i.minTickSize && i.minTickSize[1] === "quarter")
                ? f
                : a;
            ...
            for (var c = 0; c < l.length - 1; ++c) {
              if (
                e.delta <
                  (l[c][0] * o[l[c][1]] + l[c + 1][0] * o[l[c + 1][1]]) / 2 &&
                l[c][0] * o[l[c][1]] >= u
              ) {
                break;
              }
            ...
            if (p == "year") {
              if (i.minTickSize != null && i.minTickSize[1] == "year") {
                ...
                var d = Math.pow(
                  10,
                  Math.floor(Math.log(e.delta / o.year) / Math.LN10)
                );
          ...
          t.tickFormatter = function (e, t) {
            ...
            var u =
              (t.options.tickSize && t.options.tickSize[1] == "quarter") ||
              (t.options.minTickSize && t.options.minTickSize[1] == "quarter");
  ...
  e.plot.plugins.push({ init: l, options: t, name: "time", version: "1.0" });
  e.plot.formatDate = r;
})(jQuery);
