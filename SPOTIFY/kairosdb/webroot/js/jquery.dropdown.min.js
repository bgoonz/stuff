  ...
  (function (e) {
    function t(t, i) {
      ...
      if (t) {
        ...
        t.preventDefault();
        t.stopPropagation();
      } else if (s !== i.target && e(i.target).hasClass("dropdown-ignore"))
        return;
      n();
    ...
    function r() {
      ...
      t.hasClass("dropdown-relative")
        ? t.css({
            left: t.hasClass("dropdown-anchor-right")
              ? n.position().left -
                (t.outerWidth(!0) - n.outerWidth(!0)) -
                parseInt(n.css("margin-right"), 10) +
                r
              : n.position().left + parseInt(n.css("margin-left"), 10) + r,
            top:
              n.position().top +
              n.outerHeight(!0) -
        ...
        : t.css({
            left: t.hasClass("dropdown-anchor-right")
              ? n.offset().left - (t.outerWidth() - n.outerWidth()) + r
              : n.offset().left + r,
