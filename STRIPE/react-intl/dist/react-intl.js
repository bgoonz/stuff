...
(function (global, factory) {
  ...
  */
  ...
  function shouldIntlComponentUpdate(_ref2, nextProps, nextState) {
      ...
      return !shallowEquals(nextProps, props) || !shallowEquals(nextState, state) || !shallowEquals(filterProps(nextIntl, intlConfigPropNames$1), filterProps(intl, intlConfigPropNames$1));
  }
  ...
  function injectIntl(WrappedComponent) {
      ...
      var InjectIntl = function (_Component) {
          babelHelpers_inherits(InjectIntl, _Component);

          function InjectIntl(props, context) {
              babelHelpers_classCallCheck(this, InjectIntl);

              var _this = babelHelpers_possibleConstructorReturn(this, Object.getPrototypeOf(InjectIntl).call(this, props, context));

              invariantIntlContext(context);
              return _this;
          }

          babelHelpers_createClass(InjectIntl, [{
              ...
              value: function render() {
                  return React__default.createElement(WrappedComponent, babelHelpers['extends']({}, this.props, babelHelpers_defineProperty({}, intlPropName, this.context.intl), {
...
var format = Object.freeze({
  ...
  */
  ...
  var IntlPluralFormat = function IntlPluralFormat(locales) {
      var options = arguments.length <= 1 || arguments[1] === undefined ? {} : arguments[1];
      babelHelpers_classCallCheck(this, IntlPluralFormat);
  ...
  var IntlProvider = function (_Component) {
      babelHelpers_inherits(IntlProvider, _Component);

      function IntlProvider(props, context) {
          babelHelpers_classCallCheck(this, IntlProvider);

          var _this = babelHelpers_possibleConstructorReturn(this, Object.getPrototypeOf(IntlProvider).call(this, props, context));
      ...
      babelHelpers_createClass(IntlProvider, [{
          key: 'getConfig',
          value: function getConfig() {
              ...
              var config = babelHelpers['extends']({}, defaultProps, filterProps(this.props, intlConfigPropNames, intlContext));
  ...
  var FormattedDate = function (_Component) {
      babelHelpers_inherits(FormattedDate, _Component);

      function FormattedDate(props, context) {
          babelHelpers_classCallCheck(this, FormattedDate);

          var _this = babelHelpers_possibleConstructorReturn(this, Object.getPrototypeOf(FormattedDate).call(this, props, context));

          invariantIntlContext(context);
          return _this;
      }

      babelHelpers_createClass(FormattedDate, [{
          key: 'shouldComponentUpdate',
          value: function shouldComponentUpdate() {
              for (var _len = arguments.length, next = Array(_len), _key = 0; _key < _len; _key++) {
                  next[_key] = arguments[_key];
  ...
  var FormattedTime = function (_Component) {
      babelHelpers_inherits(FormattedTime, _Component);

      function FormattedTime(props, context) {
          babelHelpers_classCallCheck(this, FormattedTime);

          var _this = babelHelpers_possibleConstructorReturn(this, Object.getPrototypeOf(FormattedTime).call(this, props, context));

          invariantIntlContext(context);
          return _this;
      }

      babelHelpers_createClass(FormattedTime, [{
          key: 'shouldComponentUpdate',
          value: function shouldComponentUpdate() {
              for (var _len = arguments.length, next = Array(_len), _key = 0; _key < _len; _key++) {
                  next[_key] = arguments[_key];
  ...
  var FormattedRelative = function (_Component) {
      babelHelpers_inherits(FormattedRelative, _Component);

      function FormattedRelative(props, context) {
          babelHelpers_classCallCheck(this, FormattedRelative);

          var _this = babelHelpers_possibleConstructorReturn(this, Object.getPrototypeOf(FormattedRelative).call(this, props, context));
      ...
      babelHelpers_createClass(FormattedRelative, [{
  ...
  var FormattedNumber = function (_Component) {
      babelHelpers_inherits(FormattedNumber, _Component);

      function FormattedNumber(props, context) {
          babelHelpers_classCallCheck(this, FormattedNumber);

          var _this = babelHelpers_possibleConstructorReturn(this, Object.getPrototypeOf(FormattedNumber).call(this, props, context));

          invariantIntlContext(context);
          return _this;
      }

      babelHelpers_createClass(FormattedNumber, [{
          key: 'shouldComponentUpdate',
          value: function shouldComponentUpdate() {
              for (var _len = arguments.length, next = Array(_len), _key = 0; _key < _len; _key++) {
                  next[_key] = arguments[_key];
  ...
  var FormattedPlural = function (_Component) {
      babelHelpers_inherits(FormattedPlural, _Component);

      function FormattedPlural(props, context) {
          babelHelpers_classCallCheck(this, FormattedPlural);

          var _this = babelHelpers_possibleConstructorReturn(this, Object.getPrototypeOf(FormattedPlural).call(this, props, context));

          invariantIntlContext(context);
          return _this;
      }

      babelHelpers_createClass(FormattedPlural, [{
          key: 'shouldComponentUpdate',
          value: function shouldComponentUpdate() {
              for (var _len = arguments.length, next = Array(_len), _key = 0; _key < _len; _key++) {
                  next[_key] = arguments[_key];
  ...
  var FormattedMessage = function (_Component) {
      babelHelpers_inherits(FormattedMessage, _Component);

      function FormattedMessage(props, context) {
          babelHelpers_classCallCheck(this, FormattedMessage);

          var _this = babelHelpers_possibleConstructorReturn(this, Object.getPrototypeOf(FormattedMessage).call(this, props, context));

          invariantIntlContext(context);
          return _this;
      }

      babelHelpers_createClass(FormattedMessage, [{
          key: 'shouldComponentUpdate',
          ...
          value: function render() {
              ...
              if (typeof children === 'function') {
                  return children.apply(undefined, babelHelpers_toConsumableArray(nodes));
              }

              return React.createElement.apply(undefined, [tagName, null].concat(babelHelpers_toConsumableArray(nodes)));
          }
      }]);
  ...
  var FormattedHTMLMessage = function (_Component) {
      babelHelpers_inherits(FormattedHTMLMessage, _Component);

      function FormattedHTMLMessage(props, context) {
          babelHelpers_classCallCheck(this, FormattedHTMLMessage);

          var _this = babelHelpers_possibleConstructorReturn(this, Object.getPrototypeOf(FormattedHTMLMessage).call(this, props, context));

          invariantIntlContext(context);
          return _this;
      }

      babelHelpers_createClass(FormattedHTMLMessage, [{
          key: 'shouldComponentUpdate',
          value: function shouldComponentUpdate(nextProps) {
              var values = this.props.values;
              var nextValues = nextProps.values;
